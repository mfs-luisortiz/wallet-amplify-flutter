...
import 'package:ec2_query_v2/src/ec2_protocol/model/integer_enum.dart' as _i2;
  ...
  XmlIntEnumsOutput deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'intEnumMap':
          result.intEnumMap
              .replace(const _i4.XmlBuiltMapSerializer().deserialize(
            serializers,
            value is String ? const [] : (value as Iterable<Object?>),
            specifiedType: const FullType(
              _i3.BuiltMap,
  ...
  Iterable<Object?> serialize(
    ...
    if (intEnumMap != null) {
      result$
        ...
        ..add(const _i4.XmlBuiltMapSerializer().serialize(
          serializers,
          intEnumMap,
          specifiedType: const FullType.nullable(
            _i3.BuiltMap,
