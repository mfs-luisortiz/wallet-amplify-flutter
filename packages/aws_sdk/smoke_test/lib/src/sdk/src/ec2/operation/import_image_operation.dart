...
class ImportImageOperation extends _i1.HttpOperation<_i2.ImportImageRequest,
    _i2.ImportImageRequest, _i3.ImportImageResult, _i3.ImportImageResult> {
  /// Import single or multi-volume disk images or EBS snapshots into an Amazon Machine Image (AMI).
  ///
  /// Amazon Web Services VM Import/Export strongly recommends specifying a value for either the `--license-type` or `--usage-operation` parameter when you create a new VM Import task. This ensures your operating system is licensed appropriately and your billing is optimized.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.ImportImageRequest, _i2.ImportImageRequest,
          _i3.ImportImageResult, _i3.ImportImageResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ImportImageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ImportImageResult? output]) => 200;
  @override
  _i3.ImportImageResult buildOutput(
    _i3.ImportImageResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ImportImageResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ImportImageResult> run(
    _i2.ImportImageRequest input, {
