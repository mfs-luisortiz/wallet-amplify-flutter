...
abstract class ModifyVpnConnectionOptionsResult
  ...
  factory ModifyVpnConnectionOptionsResult({_i2.VpnConnection? vpnConnection}) {
  ...
  static const List<_i3.SmithySerializer> serializers = [
    ModifyVpnConnectionOptionsResultEc2QuerySerializer()
  ];

  @BuiltValueHook(initializeBuilder: true)
  static void _init(ModifyVpnConnectionOptionsResultBuilder b) {}
...
class ModifyVpnConnectionOptionsResultEc2QuerySerializer
    extends _i3.StructuredSmithySerializer<ModifyVpnConnectionOptionsResult> {
