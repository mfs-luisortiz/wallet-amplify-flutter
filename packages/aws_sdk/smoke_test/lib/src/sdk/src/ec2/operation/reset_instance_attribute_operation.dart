...
class ResetInstanceAttributeOperation extends _i1.HttpOperation<
    _i2.ResetInstanceAttributeRequest,
    _i2.ResetInstanceAttributeRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Resets an attribute of an instance to its default value. To reset the `kernel` or `ramdisk`, the instance must be in a stopped state. To reset the `sourceDestCheck`, the instance can be either running or stopped.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.ResetInstanceAttributeRequest,
          _i2.ResetInstanceAttributeRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ResetInstanceAttributeRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.ResetInstanceAttributeRequest input, {
