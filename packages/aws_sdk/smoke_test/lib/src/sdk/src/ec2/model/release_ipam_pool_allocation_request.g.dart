...
class _$ReleaseIpamPoolAllocationRequest
  ...
  _$ReleaseIpamPoolAllocationRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        ipamPoolId, r'ReleaseIpamPoolAllocationRequest', 'ipamPoolId');
    BuiltValueNullFieldError.checkNotNull(
        cidr, r'ReleaseIpamPoolAllocationRequest', 'cidr');
    BuiltValueNullFieldError.checkNotNull(ipamPoolAllocationId,
        r'ReleaseIpamPoolAllocationRequest', 'ipamPoolAllocationId');
  }
    ...
    final _$result = _$v ??
        new _$ReleaseIpamPoolAllocationRequest._(
            ...
            cidr: BuiltValueNullFieldError.checkNotNull(
                cidr, r'ReleaseIpamPoolAllocationRequest', 'cidr'),
            ipamPoolAllocationId: BuiltValueNullFieldError.checkNotNull(
                ipamPoolAllocationId,
                r'ReleaseIpamPoolAllocationRequest',
                'ipamPoolAllocationId'));
    replace(_$result);
    return _$result;
  }
