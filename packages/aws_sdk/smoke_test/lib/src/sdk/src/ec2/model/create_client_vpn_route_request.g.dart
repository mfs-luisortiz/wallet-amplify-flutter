...
class _$CreateClientVpnRouteRequest extends CreateClientVpnRouteRequest {
  ...
  _$CreateClientVpnRouteRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(clientVpnEndpointId,
        r'CreateClientVpnRouteRequest', 'clientVpnEndpointId');
    BuiltValueNullFieldError.checkNotNull(destinationCidrBlock,
        r'CreateClientVpnRouteRequest', 'destinationCidrBlock');
    BuiltValueNullFieldError.checkNotNull(
        targetVpcSubnetId, r'CreateClientVpnRouteRequest', 'targetVpcSubnetId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$CreateClientVpnRouteRequest._(
            clientVpnEndpointId: BuiltValueNullFieldError.checkNotNull(
                clientVpnEndpointId,
                r'CreateClientVpnRouteRequest',
                'clientVpnEndpointId'),
            destinationCidrBlock: BuiltValueNullFieldError.checkNotNull(
                destinationCidrBlock,
                r'CreateClientVpnRouteRequest',
                'destinationCidrBlock'),
            targetVpcSubnetId: BuiltValueNullFieldError.checkNotNull(
                targetVpcSubnetId,
                r'CreateClientVpnRouteRequest',
                'targetVpcSubnetId'),
