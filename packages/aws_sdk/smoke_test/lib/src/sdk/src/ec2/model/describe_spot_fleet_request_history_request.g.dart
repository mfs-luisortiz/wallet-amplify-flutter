...
class _$DescribeSpotFleetRequestHistoryRequest
  ...
  _$DescribeSpotFleetRequestHistoryRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(spotFleetRequestId,
        r'DescribeSpotFleetRequestHistoryRequest', 'spotFleetRequestId');
    BuiltValueNullFieldError.checkNotNull(
        startTime, r'DescribeSpotFleetRequestHistoryRequest', 'startTime');
  }
...
class DescribeSpotFleetRequestHistoryRequestBuilder
  ...
  _i3.EventType? _eventType;
  _i3.EventType? get eventType => _$this._eventType;
  set eventType(_i3.EventType? eventType) => _$this._eventType = eventType;
    ...
    final _$result = _$v ??
        new _$DescribeSpotFleetRequestHistoryRequest._(
            ...
            spotFleetRequestId: BuiltValueNullFieldError.checkNotNull(
                spotFleetRequestId,
                r'DescribeSpotFleetRequestHistoryRequest',
                'spotFleetRequestId'),
            startTime: BuiltValueNullFieldError.checkNotNull(startTime,
                r'DescribeSpotFleetRequestHistoryRequest', 'startTime'));
    replace(_$result);
    return _$result;
  }
}
