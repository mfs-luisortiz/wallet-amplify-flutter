...
abstract class EnableFastLaunchRequest
  ...
  factory EnableFastLaunchRequest({
    ...
    String? resourceType,
    _i3.FastLaunchSnapshotConfigurationRequest? snapshotConfiguration,
    _i4.FastLaunchLaunchTemplateSpecificationRequest? launchTemplate,
  ...
  _i3.FastLaunchSnapshotConfigurationRequest? get snapshotConfiguration;

  /// The launch template to use when launching Windows instances from pre-provisioned snapshots. Launch template parameters can include either the name or ID of the launch template, but not both.
  _i4.FastLaunchLaunchTemplateSpecificationRequest? get launchTemplate;
