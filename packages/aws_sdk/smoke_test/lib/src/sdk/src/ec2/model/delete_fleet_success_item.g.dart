...
class _$DeleteFleetSuccessItem extends DeleteFleetSuccessItem {
  @override
  final _i2.FleetStateCode? currentFleetState;
  @override
  final _i2.FleetStateCode? previousFleetState;
  @override
...
class DeleteFleetSuccessItemBuilder
  ...
  _i2.FleetStateCode? _currentFleetState;
  _i2.FleetStateCode? get currentFleetState => _$this._currentFleetState;
  set currentFleetState(_i2.FleetStateCode? currentFleetState) =>
      _$this._currentFleetState = currentFleetState;

  _i2.FleetStateCode? _previousFleetState;
  _i2.FleetStateCode? get previousFleetState => _$this._previousFleetState;
  set previousFleetState(_i2.FleetStateCode? previousFleetState) =>
  ...
  DeleteFleetSuccessItemBuilder() {
    DeleteFleetSuccessItem._init(this);
  }
