...
class _$DeleteNetworkAclRequest extends DeleteNetworkAclRequest {
  ...
  _$DeleteNetworkAclRequest._(
      {required this.dryRun, required this.networkAclId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeleteNetworkAclRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        networkAclId, r'DeleteNetworkAclRequest', 'networkAclId');
  }
    ...
    final _$result = _$v ??
        new _$DeleteNetworkAclRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'DeleteNetworkAclRequest', 'dryRun'),
            networkAclId: BuiltValueNullFieldError.checkNotNull(
                networkAclId, r'DeleteNetworkAclRequest', 'networkAclId'));
    replace(_$result);
    return _$result;
  }
