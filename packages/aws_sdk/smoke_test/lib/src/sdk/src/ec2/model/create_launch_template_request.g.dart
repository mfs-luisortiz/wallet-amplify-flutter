...
class _$CreateLaunchTemplateRequest extends CreateLaunchTemplateRequest {
  ...
  @override
  final _i3.RequestLaunchTemplateData launchTemplateData;
  @override
  ...
  _$CreateLaunchTemplateRequest._(
      ...
      required this.launchTemplateData,
      this.tagSpecifications})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'CreateLaunchTemplateRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(launchTemplateName,
        r'CreateLaunchTemplateRequest', 'launchTemplateName');
    BuiltValueNullFieldError.checkNotNull(launchTemplateData,
        r'CreateLaunchTemplateRequest', 'launchTemplateData');
  }
...
class CreateLaunchTemplateRequestBuilder
  ...
  _i3.RequestLaunchTemplateDataBuilder? _launchTemplateData;
  _i3.RequestLaunchTemplateDataBuilder get launchTemplateData =>
      _$this._launchTemplateData ??= new _i3.RequestLaunchTemplateDataBuilder();
  set launchTemplateData(
          _i3.RequestLaunchTemplateDataBuilder? launchTemplateData) =>
    ...
    try {
      _$result = _$v ??
          new _$CreateLaunchTemplateRequest._(
              ...
              launchTemplateName: BuiltValueNullFieldError.checkNotNull(
                  launchTemplateName,
                  r'CreateLaunchTemplateRequest',
                  'launchTemplateName'),
              versionDescription: versionDescription,
              launchTemplateData: launchTemplateData.build(),
              tagSpecifications: _tagSpecifications?.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'launchTemplateData';
        launchTemplateData.build();
