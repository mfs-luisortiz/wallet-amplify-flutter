...
class _$RegisterImageRequest extends RegisterImageRequest {
  ...
  @override
  final _i3.ArchitectureValues? architecture;
  @override
  final _i8.BuiltList<_i4.BlockDeviceMapping>? blockDeviceMappings;
  @override
  ...
  final String name;
  @override
  final _i8.BuiltList<String>? billingProducts;
  @override
  ...
  @override
  final _i5.BootModeValues? bootMode;
  @override
  final _i6.TpmSupportValues? tpmSupport;
  @override
  final String? uefiData;
  @override
  final _i7.ImdsSupportValues? imdsSupport;
  ...
  _$RegisterImageRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        name, r'RegisterImageRequest', 'name');
  }
...
class RegisterImageRequestBuilder
  ...
  _i3.ArchitectureValues? _architecture;
  _i3.ArchitectureValues? get architecture => _$this._architecture;
  set architecture(_i3.ArchitectureValues? architecture) =>
      _$this._architecture = architecture;

  _i8.ListBuilder<_i4.BlockDeviceMapping>? _blockDeviceMappings;
  _i8.ListBuilder<_i4.BlockDeviceMapping> get blockDeviceMappings =>
      _$this._blockDeviceMappings ??=
          new _i8.ListBuilder<_i4.BlockDeviceMapping>();
  set blockDeviceMappings(
          _i8.ListBuilder<_i4.BlockDeviceMapping>? blockDeviceMappings) =>
  ...
  _i8.ListBuilder<String>? _billingProducts;
  _i8.ListBuilder<String> get billingProducts =>
      _$this._billingProducts ??= new _i8.ListBuilder<String>();
  set billingProducts(_i8.ListBuilder<String>? billingProducts) =>
  ...
  _i5.BootModeValues? _bootMode;
  _i5.BootModeValues? get bootMode => _$this._bootMode;
  set bootMode(_i5.BootModeValues? bootMode) => _$this._bootMode = bootMode;

  _i6.TpmSupportValues? _tpmSupport;
  _i6.TpmSupportValues? get tpmSupport => _$this._tpmSupport;
  set tpmSupport(_i6.TpmSupportValues? tpmSupport) =>
  ...
  _i7.ImdsSupportValues? _imdsSupport;
  _i7.ImdsSupportValues? get imdsSupport => _$this._imdsSupport;
  set imdsSupport(_i7.ImdsSupportValues? imdsSupport) =>
