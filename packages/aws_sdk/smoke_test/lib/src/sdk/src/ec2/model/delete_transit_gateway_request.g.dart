...
class _$DeleteTransitGatewayRequest extends DeleteTransitGatewayRequest {
  ...
  _$DeleteTransitGatewayRequest._(
      {required this.transitGatewayId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        transitGatewayId, r'DeleteTransitGatewayRequest', 'transitGatewayId');
    BuiltValueNullFieldError.checkNotNull(
