...
class DeprovisionByoipCidrOperation extends _i1.HttpOperation<
    _i2.DeprovisionByoipCidrRequest,
    _i2.DeprovisionByoipCidrRequest,
    _i3.DeprovisionByoipCidrResult,
    _i3.DeprovisionByoipCidrResult> {
  /// Releases the specified address range that you provisioned for use with your Amazon Web Services resources through bring your own IP addresses (BYOIP) and deletes the corresponding address pool.
  ///
  /// Before you can release an address range, you must stop advertising it using WithdrawByoipCidr and you must not have any IP addresses allocated from its address range.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DeprovisionByoipCidrRequest,
          _i3.DeprovisionByoipCidrResult,
          _i3.DeprovisionByoipCidrResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeprovisionByoipCidrRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DeprovisionByoipCidrResult? output]) => 200;
  @override
  _i3.DeprovisionByoipCidrResult buildOutput(
    _i3.DeprovisionByoipCidrResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DeprovisionByoipCidrResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DeprovisionByoipCidrResult> run(
    _i2.DeprovisionByoipCidrRequest input, {
