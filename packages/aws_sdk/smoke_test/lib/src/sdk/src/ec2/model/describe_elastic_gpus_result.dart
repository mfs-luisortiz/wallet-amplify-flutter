...
import 'package:smoke_test/src/sdk/src/ec2/model/elastic_gpus.dart' as _i2;
...
abstract class DescribeElasticGpusResult
  ...
  factory DescribeElasticGpusResult({
    List<_i2.ElasticGpus>? elasticGpuSet,
    int? maxResults,
    String? nextToken,
  }) {
    maxResults ??= 0;
    return _$DescribeElasticGpusResult._(
      elasticGpuSet:
          elasticGpuSet == null ? null : _i3.BuiltList(elasticGpuSet),
  ...
  static const List<_i4.SmithySerializer> serializers = [
    DescribeElasticGpusResultEc2QuerySerializer()
  ];
  ...
  _i3.BuiltList<_i2.ElasticGpus>? get elasticGpuSet;
...
class DescribeElasticGpusResultEc2QuerySerializer
    extends _i4.StructuredSmithySerializer<DescribeElasticGpusResult> {
  ...
  DescribeElasticGpusResult deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'elasticGpuSet':
          result.elasticGpuSet.replace((const _i4.XmlBuiltListSerializer(
            memberName: 'item',
            ...
            specifiedType: const FullType(
              _i3.BuiltList,
              [FullType(_i2.ElasticGpus)],
            ),
          ) as _i3.BuiltList<_i2.ElasticGpus>));
        case 'maxResults':
  ...
  Iterable<Object?> serialize(
    ...
    if (elasticGpuSet != null) {
      result$
        ..add(const _i4.XmlElementName('ElasticGpuSet'))
    ...
    result$
      ..add(const _i4.XmlElementName('MaxResults'))
