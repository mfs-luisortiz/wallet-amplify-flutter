...
class _$ResetFpgaImageAttributeRequest extends ResetFpgaImageAttributeRequest {
  ...
  @override
  final _i3.ResetFpgaImageAttributeName? attribute;
  ...
  _$ResetFpgaImageAttributeRequest._(
      {required this.dryRun, required this.fpgaImageId, this.attribute})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'ResetFpgaImageAttributeRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        fpgaImageId, r'ResetFpgaImageAttributeRequest', 'fpgaImageId');
  }
...
class ResetFpgaImageAttributeRequestBuilder
  ...
  _i3.ResetFpgaImageAttributeName? _attribute;
  _i3.ResetFpgaImageAttributeName? get attribute => _$this._attribute;
  set attribute(_i3.ResetFpgaImageAttributeName? attribute) =>
    ...
    final _$result = _$v ??
        new _$ResetFpgaImageAttributeRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'ResetFpgaImageAttributeRequest', 'dryRun'),
            fpgaImageId: BuiltValueNullFieldError.checkNotNull(
                fpgaImageId, r'ResetFpgaImageAttributeRequest', 'fpgaImageId'),
            attribute: attribute);
    replace(_$result);
    return _$result;
