...
class _$DisableFastSnapshotRestoresRequest
  ...
  _$DisableFastSnapshotRestoresRequest._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(availabilityZones,
        r'DisableFastSnapshotRestoresRequest', 'availabilityZones');
    BuiltValueNullFieldError.checkNotNull(sourceSnapshotIds,
        r'DisableFastSnapshotRestoresRequest', 'sourceSnapshotIds');
    ...
    try {
      _$result = _$v ??
          new _$DisableFastSnapshotRestoresRequest._(
              availabilityZones: availabilityZones.build(),
              sourceSnapshotIds: sourceSnapshotIds.build(),
      ...
      try {
        ...
        availabilityZones.build();
        _$failedField = 'sourceSnapshotIds';
        sourceSnapshotIds.build();
      } catch (e) {
