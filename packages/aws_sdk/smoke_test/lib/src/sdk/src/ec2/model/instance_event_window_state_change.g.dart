...
class _$InstanceEventWindowStateChange extends InstanceEventWindowStateChange {
  ...
  @override
  final _i2.InstanceEventWindowState? state;
...
class InstanceEventWindowStateChangeBuilder
  ...
  _i2.InstanceEventWindowState? _state;
  _i2.InstanceEventWindowState? get state => _$this._state;
  set state(_i2.InstanceEventWindowState? state) => _$this._state = state;

  InstanceEventWindowStateChangeBuilder() {
    InstanceEventWindowStateChange._init(this);
  }
