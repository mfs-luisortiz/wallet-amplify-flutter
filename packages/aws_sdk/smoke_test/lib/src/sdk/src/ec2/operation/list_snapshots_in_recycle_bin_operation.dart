...
class ListSnapshotsInRecycleBinOperation extends _i1.PaginatedHttpOperation<
    _i2.ListSnapshotsInRecycleBinRequest,
    _i2.ListSnapshotsInRecycleBinRequest,
    _i3.ListSnapshotsInRecycleBinResult,
    _i3.ListSnapshotsInRecycleBinResult,
    String,
    int,
    _i4.BuiltList<_i5.SnapshotRecycleBinInfo>> {
  /// Lists one or more snapshots that are currently in the Recycle Bin.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListSnapshotsInRecycleBinRequest,
          _i3.ListSnapshotsInRecycleBinResult,
          _i3.ListSnapshotsInRecycleBinResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListSnapshotsInRecycleBinRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListSnapshotsInRecycleBinResult? output]) => 200;
  @override
  _i3.ListSnapshotsInRecycleBinResult buildOutput(
    _i3.ListSnapshotsInRecycleBinResult payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ListSnapshotsInRecycleBinResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListSnapshotsInRecycleBinResult> run(
    _i2.ListSnapshotsInRecycleBinRequest input, {
  ...
  @override
  String? getToken(_i3.ListSnapshotsInRecycleBinResult output) =>
      output.nextToken;
  @override
  _i4.BuiltList<_i5.SnapshotRecycleBinInfo> getItems(
          _i3.ListSnapshotsInRecycleBinResult output) =>
      output.snapshots ?? _i4.BuiltList();
  @override
  _i2.ListSnapshotsInRecycleBinRequest rebuildInput(
    _i2.ListSnapshotsInRecycleBinRequest input,
    String token,
    int? pageSize,
  ) =>
