...
class ModifyTrafficMirrorFilterRuleOperation extends _i1.HttpOperation<
    _i2.ModifyTrafficMirrorFilterRuleRequest,
    _i2.ModifyTrafficMirrorFilterRuleRequest,
    _i3.ModifyTrafficMirrorFilterRuleResult,
    _i3.ModifyTrafficMirrorFilterRuleResult> {
  /// Modifies the specified Traffic Mirror rule.
  ///
  /// `DestinationCidrBlock` and `SourceCidrBlock` must both be an IPv4 range or an IPv6 range.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyTrafficMirrorFilterRuleRequest,
          _i3.ModifyTrafficMirrorFilterRuleResult,
          _i3.ModifyTrafficMirrorFilterRuleResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.ModifyTrafficMirrorFilterRuleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ModifyTrafficMirrorFilterRuleResult? output]) => 200;
  @override
  _i3.ModifyTrafficMirrorFilterRuleResult buildOutput(
    _i3.ModifyTrafficMirrorFilterRuleResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyTrafficMirrorFilterRuleResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyTrafficMirrorFilterRuleResult> run(
    _i2.ModifyTrafficMirrorFilterRuleRequest input, {
