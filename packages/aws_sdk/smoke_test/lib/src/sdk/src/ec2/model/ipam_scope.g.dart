...
class _$IpamScope extends IpamScope {
  ...
  final int poolCount;
  @override
  final _i3.IpamScopeState? state;
  @override
...
class IpamScopeBuilder implements Builder<IpamScope, IpamScopeBuilder> {
  ...
  _i3.IpamScopeState? _state;
  _i3.IpamScopeState? get state => _$this._state;
  set state(_i3.IpamScopeState? state) => _$this._state = state;
