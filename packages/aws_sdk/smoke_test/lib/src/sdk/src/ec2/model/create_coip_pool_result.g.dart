...
class CreateCoipPoolResultBuilder
  ...
  _i2.CoipPoolBuilder? _coipPool;
  _i2.CoipPoolBuilder get coipPool =>
      _$this._coipPool ??= new _i2.CoipPoolBuilder();
  set coipPool(_i2.CoipPoolBuilder? coipPool) => _$this._coipPool = coipPool;

  CreateCoipPoolResultBuilder() {
    CreateCoipPoolResult._init(this);
  }
