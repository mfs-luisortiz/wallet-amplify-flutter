...
abstract class ModifySnapshotTierRequest
  ...
  factory ModifySnapshotTierRequest({
    ...
    _i3.TargetStorageTier? storageTier,
    bool? dryRun,
  }) {
    dryRun ??= false;
  ...
  static const List<_i1.SmithySerializer> serializers = [
    ModifySnapshotTierRequestEc2QuerySerializer()
  ];
  ...
  _i3.TargetStorageTier? get storageTier;
      ...
      switch (key) {
        ...
        case 'StorageTier':
          result.storageTier = (serializers.deserialize(
            value,
            specifiedType: const FullType(_i3.TargetStorageTier),
          ) as _i3.TargetStorageTier);
        case 'DryRun':
  ...
  Iterable<Object?> serialize(
    ...
    if (storageTier != null) {
      result$
        ...
        ..add(serializers.serialize(
          storageTier,
          specifiedType: const FullType.nullable(_i3.TargetStorageTier),
        ));
    }
    result$
