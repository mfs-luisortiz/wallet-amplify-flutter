...
class _$CoipPool extends CoipPool {
  ...
  final String? poolId;
  @override
  final _i3.BuiltList<String>? poolCidrs;
  @override
...
class CoipPoolBuilder implements Builder<CoipPool, CoipPoolBuilder> {
  ...
  _i3.ListBuilder<String>? _poolCidrs;
  _i3.ListBuilder<String> get poolCidrs =>
      _$this._poolCidrs ??= new _i3.ListBuilder<String>();
  set poolCidrs(_i3.ListBuilder<String>? poolCidrs) =>
