...
class _$DeleteTransitGatewayPrefixListReferenceRequest
  ...
  _$DeleteTransitGatewayPrefixListReferenceRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        ...
        r'DeleteTransitGatewayPrefixListReferenceRequest',
        'transitGatewayRouteTableId');
    BuiltValueNullFieldError.checkNotNull(prefixListId,
        r'DeleteTransitGatewayPrefixListReferenceRequest', 'prefixListId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$DeleteTransitGatewayPrefixListReferenceRequest._(
            transitGatewayRouteTableId: BuiltValueNullFieldError.checkNotNull(
                ...
                r'DeleteTransitGatewayPrefixListReferenceRequest',
                'transitGatewayRouteTableId'),
            prefixListId: BuiltValueNullFieldError.checkNotNull(
                prefixListId,
                r'DeleteTransitGatewayPrefixListReferenceRequest',
                'prefixListId'),
