...
class ModifyEbsDefaultKmsKeyIdOperation extends _i1.HttpOperation<
    _i2.ModifyEbsDefaultKmsKeyIdRequest,
    _i2.ModifyEbsDefaultKmsKeyIdRequest,
    _i3.ModifyEbsDefaultKmsKeyIdResult,
    _i3.ModifyEbsDefaultKmsKeyIdResult> {
  /// Changes the default KMS key for EBS encryption by default for your account in this Region.
  ///
  /// Amazon Web Services creates a unique Amazon Web Services managed KMS key in each Region for use with encryption by default. If you change the default KMS key to a symmetric customer managed KMS key, it is used instead of the Amazon Web Services managed KMS key. To reset the default KMS key to the Amazon Web Services managed KMS key for EBS, use ResetEbsDefaultKmsKeyId. Amazon EBS does not support asymmetric KMS keys.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyEbsDefaultKmsKeyIdRequest,
          _i3.ModifyEbsDefaultKmsKeyIdResult,
          _i3.ModifyEbsDefaultKmsKeyIdResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ModifyEbsDefaultKmsKeyIdRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ModifyEbsDefaultKmsKeyIdResult? output]) => 200;
  @override
  _i3.ModifyEbsDefaultKmsKeyIdResult buildOutput(
    _i3.ModifyEbsDefaultKmsKeyIdResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyEbsDefaultKmsKeyIdResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyEbsDefaultKmsKeyIdResult> run(
    _i2.ModifyEbsDefaultKmsKeyIdRequest input, {
