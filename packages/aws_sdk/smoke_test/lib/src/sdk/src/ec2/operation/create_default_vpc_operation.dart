...
class CreateDefaultVpcOperation extends _i1.HttpOperation<
    _i2.CreateDefaultVpcRequest,
    _i2.CreateDefaultVpcRequest,
    _i3.CreateDefaultVpcResult,
    _i3.CreateDefaultVpcResult> {
  /// Creates a default VPC with a size `/16` IPv4 CIDR block and a default subnet in each Availability Zone. For more information about the components of a default VPC, see [Default VPC and default subnets](https://docs.aws.amazon.com/vpc/latest/userguide/default-vpc.html) in the _Amazon Virtual Private Cloud User Guide_. You cannot specify the components of the default VPC yourself.
  ///
  /// If you deleted your previous default VPC, you can create a default VPC. You cannot have more than one default VPC per Region.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateDefaultVpcRequest, _i2.CreateDefaultVpcRequest,
          _i3.CreateDefaultVpcResult, _i3.CreateDefaultVpcResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateDefaultVpcRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateDefaultVpcResult? output]) => 200;
  @override
  _i3.CreateDefaultVpcResult buildOutput(
    _i3.CreateDefaultVpcResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateDefaultVpcResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateDefaultVpcResult> run(
    _i2.CreateDefaultVpcRequest input, {
