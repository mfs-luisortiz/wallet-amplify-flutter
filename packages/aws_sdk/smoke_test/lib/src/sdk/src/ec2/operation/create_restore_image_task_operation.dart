...
class CreateRestoreImageTaskOperation extends _i1.HttpOperation<
    _i2.CreateRestoreImageTaskRequest,
    _i2.CreateRestoreImageTaskRequest,
    _i3.CreateRestoreImageTaskResult,
    _i3.CreateRestoreImageTaskResult> {
  /// Starts a task that restores an AMI from an Amazon S3 object that was previously created by using [CreateStoreImageTask](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateStoreImageTask.html).
  ///
  /// To use this API, you must have the required permissions. For more information, see [Permissions for storing and restoring AMIs using Amazon S3](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ami-store-restore.html#ami-s3-permissions) in the _Amazon Elastic Compute Cloud User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateRestoreImageTaskRequest,
          _i3.CreateRestoreImageTaskResult,
          _i3.CreateRestoreImageTaskResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateRestoreImageTaskRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateRestoreImageTaskResult? output]) => 200;
  @override
  _i3.CreateRestoreImageTaskResult buildOutput(
    _i3.CreateRestoreImageTaskResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateRestoreImageTaskResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateRestoreImageTaskResult> run(
    _i2.CreateRestoreImageTaskRequest input, {
