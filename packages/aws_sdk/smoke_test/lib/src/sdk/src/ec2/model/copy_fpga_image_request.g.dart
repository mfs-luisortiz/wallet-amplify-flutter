...
class _$CopyFpgaImageRequest extends CopyFpgaImageRequest {
  ...
  _$CopyFpgaImageRequest._(
      ...
      required this.sourceFpgaImageId,
      this.description,
      this.name,
    ...
    BuiltValueNullFieldError.checkNotNull(
        sourceFpgaImageId, r'CopyFpgaImageRequest', 'sourceFpgaImageId');
    BuiltValueNullFieldError.checkNotNull(
        sourceRegion, r'CopyFpgaImageRequest', 'sourceRegion');
  }
    ...
    final _$result = _$v ??
        new _$CopyFpgaImageRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'CopyFpgaImageRequest', 'dryRun'),
            sourceFpgaImageId: BuiltValueNullFieldError.checkNotNull(
                sourceFpgaImageId,
                r'CopyFpgaImageRequest',
                'sourceFpgaImageId'),
