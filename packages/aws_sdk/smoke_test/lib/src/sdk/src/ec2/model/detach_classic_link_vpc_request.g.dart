...
class _$DetachClassicLinkVpcRequest extends DetachClassicLinkVpcRequest {
  ...
  _$DetachClassicLinkVpcRequest._(
      {required this.dryRun, required this.instanceId, required this.vpcId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DetachClassicLinkVpcRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        instanceId, r'DetachClassicLinkVpcRequest', 'instanceId');
    BuiltValueNullFieldError.checkNotNull(
        vpcId, r'DetachClassicLinkVpcRequest', 'vpcId');
  }
