...
class _$SecurityGroupRuleUpdate extends SecurityGroupRuleUpdate {
  ...
  @override
  final _i2.SecurityGroupRuleRequest? securityGroupRule;
...
class SecurityGroupRuleUpdateBuilder
  ...
  _i2.SecurityGroupRuleRequestBuilder? _securityGroupRule;
  _i2.SecurityGroupRuleRequestBuilder get securityGroupRule =>
      _$this._securityGroupRule ??= new _i2.SecurityGroupRuleRequestBuilder();
  set securityGroupRule(
          _i2.SecurityGroupRuleRequestBuilder? securityGroupRule) =>
      _$this._securityGroupRule = securityGroupRule;

  SecurityGroupRuleUpdateBuilder() {
    SecurityGroupRuleUpdate._init(this);
  }
