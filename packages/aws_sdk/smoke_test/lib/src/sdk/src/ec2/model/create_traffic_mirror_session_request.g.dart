...
class _$CreateTrafficMirrorSessionRequest
  ...
  _$CreateTrafficMirrorSessionRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(networkInterfaceId,
        r'CreateTrafficMirrorSessionRequest', 'networkInterfaceId');
    BuiltValueNullFieldError.checkNotNull(trafficMirrorTargetId,
        r'CreateTrafficMirrorSessionRequest', 'trafficMirrorTargetId');
    BuiltValueNullFieldError.checkNotNull(trafficMirrorFilterId,
        r'CreateTrafficMirrorSessionRequest', 'trafficMirrorFilterId');
      ...
      _$result = _$v ??
          new _$CreateTrafficMirrorSessionRequest._(
              networkInterfaceId: BuiltValueNullFieldError.checkNotNull(
                  ...
                  'networkInterfaceId'),
              trafficMirrorTargetId: BuiltValueNullFieldError.checkNotNull(
                  trafficMirrorTargetId, r'CreateTrafficMirrorSessionRequest', 'trafficMirrorTargetId'),
              ...
              virtualNetworkId: BuiltValueNullFieldError.checkNotNull(
                  virtualNetworkId, r'CreateTrafficMirrorSessionRequest', 'virtualNetworkId'),
              description: description,
              tagSpecifications: _tagSpecifications?.build(),
              dryRun: BuiltValueNullFieldError.checkNotNull(dryRun, r'CreateTrafficMirrorSessionRequest', 'dryRun'),
