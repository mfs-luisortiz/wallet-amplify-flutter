...
class EnableSerialConsoleAccessOperation extends _i1.HttpOperation<
    _i2.EnableSerialConsoleAccessRequest,
    _i2.EnableSerialConsoleAccessRequest,
    _i3.EnableSerialConsoleAccessResult,
    _i3.EnableSerialConsoleAccessResult> {
  /// Enables access to the EC2 serial console of all instances for your account. By default, access to the EC2 serial console is disabled for your account. For more information, see [Manage account access to the EC2 serial console](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configure-access-to-serial-console.html#serial-console-account-access) in the _Amazon EC2 User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.EnableSerialConsoleAccessRequest,
          _i3.EnableSerialConsoleAccessResult,
          _i3.EnableSerialConsoleAccessResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.EnableSerialConsoleAccessRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.EnableSerialConsoleAccessResult? output]) => 200;
  @override
  _i3.EnableSerialConsoleAccessResult buildOutput(
    _i3.EnableSerialConsoleAccessResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.EnableSerialConsoleAccessResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.EnableSerialConsoleAccessResult> run(
    _i2.EnableSerialConsoleAccessRequest input, {
