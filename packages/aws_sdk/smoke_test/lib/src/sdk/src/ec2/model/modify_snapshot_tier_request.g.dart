...
class _$ModifySnapshotTierRequest extends ModifySnapshotTierRequest {
  ...
  @override
  final _i3.TargetStorageTier? storageTier;
  @override
  final bool dryRun;
  ...
  _$ModifySnapshotTierRequest._(
      {required this.snapshotId, this.storageTier, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        snapshotId, r'ModifySnapshotTierRequest', 'snapshotId');
    BuiltValueNullFieldError.checkNotNull(
...
class ModifySnapshotTierRequestBuilder
  ...
  _i3.TargetStorageTier? _storageTier;
  _i3.TargetStorageTier? get storageTier => _$this._storageTier;
  set storageTier(_i3.TargetStorageTier? storageTier) =>
