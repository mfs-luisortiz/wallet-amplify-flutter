...
abstract class PublicIpv4Pool
  ...
  factory PublicIpv4Pool({
    String? poolId,
    String? description,
    List<_i2.PublicIpv4PoolRange>? poolAddressRanges,
    ...
    return _$PublicIpv4Pool._(
      ...
      poolAddressRanges:
          poolAddressRanges == null ? null : _i4.BuiltList(poolAddressRanges),
  ...
  static void _init(PublicIpv4PoolBuilder b) {
    b.totalAddressCount = 0;
    b.totalAvailableAddressCount = 0;
  }
  ...
  /// The address ranges.
  _i4.BuiltList<_i2.PublicIpv4PoolRange>? get poolAddressRanges;
...
class PublicIpv4PoolEc2QuerySerializer
    extends _i5.StructuredSmithySerializer<PublicIpv4Pool> {
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'poolAddressRangeSet':
          result.poolAddressRanges.replace((const _i5.XmlBuiltListSerializer(
            memberName: 'item',
            ...
            specifiedType: const FullType(
              _i4.BuiltList,
              [FullType(_i2.PublicIpv4PoolRange)],
            ),
          ) as _i4.BuiltList<_i2.PublicIpv4PoolRange>));
  ...
  Iterable<Object?> serialize(
    ...
    if (poolAddressRanges != null) {
      result$
        ..add(const _i5.XmlElementName('PoolAddressRangeSet'))
    ...
    result$
      ..add(const _i5.XmlElementName('TotalAddressCount'))
      ..add(serializers.serialize(
        totalAddressCount,
        specifiedType: const FullType(int),
      ));
    result$
      ..add(const _i5.XmlElementName('TotalAvailableAddressCount'))
      ..add(serializers.serialize(
        totalAvailableAddressCount,
        specifiedType: const FullType(int),
      ));
