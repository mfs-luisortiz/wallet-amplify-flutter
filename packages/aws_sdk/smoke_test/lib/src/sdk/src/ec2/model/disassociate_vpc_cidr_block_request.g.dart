...
class _$DisassociateVpcCidrBlockRequest
  ...
  _$DisassociateVpcCidrBlockRequest._({required this.associationId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        associationId, r'DisassociateVpcCidrBlockRequest', 'associationId');
  }
...
class DisassociateVpcCidrBlockRequestBuilder
  ...
  DisassociateVpcCidrBlockRequestBuilder() {
    DisassociateVpcCidrBlockRequest._init(this);
  }
  ...
  _$DisassociateVpcCidrBlockRequest _build() {
    final _$result = _$v ??
        new _$DisassociateVpcCidrBlockRequest._(
            associationId: BuiltValueNullFieldError.checkNotNull(associationId,
                r'DisassociateVpcCidrBlockRequest', 'associationId'));
    replace(_$result);
    return _$result;
  }
}
