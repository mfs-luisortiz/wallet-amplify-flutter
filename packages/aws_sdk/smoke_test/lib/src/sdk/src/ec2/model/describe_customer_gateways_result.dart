...
abstract class DescribeCustomerGatewaysResult
  ...
  factory DescribeCustomerGatewaysResult(
      {List<_i2.CustomerGateway>? customerGateways}) {
    return _$DescribeCustomerGatewaysResult._(
        customerGateways:
            customerGateways == null ? null : _i3.BuiltList(customerGateways));
  }
  ...
  static const List<_i4.SmithySerializer> serializers = [
    DescribeCustomerGatewaysResultEc2QuerySerializer()
  ];

  @BuiltValueHook(initializeBuilder: true)
  static void _init(DescribeCustomerGatewaysResultBuilder b) {}

  /// Information about one or more customer gateways.
  _i3.BuiltList<_i2.CustomerGateway>? get customerGateways;
  @override
  List<Object?> get props => [customerGateways];
  @override
  String toString() {
    final helper =
        newBuiltValueToStringHelper('DescribeCustomerGatewaysResult');
    helper.add(
      'customerGateways',
      customerGateways,
    );
...
class DescribeCustomerGatewaysResultEc2QuerySerializer
    extends _i4.StructuredSmithySerializer<DescribeCustomerGatewaysResult> {
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'customerGatewaySet':
          result.customerGateways.replace((const _i4.XmlBuiltListSerializer(
            memberName: 'item',
            ...
            specifiedType: const FullType(
              _i3.BuiltList,
              [FullType(_i2.CustomerGateway)],
            ),
          ) as _i3.BuiltList<_i2.CustomerGateway>));
      }
    }
  ...
  Iterable<Object?> serialize(
    ...
    if (customerGateways != null) {
      result$
        ..add(const _i4.XmlElementName('CustomerGatewaySet'))
