...
class SendDiagnosticInterruptOperation extends _i1.HttpOperation<
    _i2.SendDiagnosticInterruptRequest,
    _i2.SendDiagnosticInterruptRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Sends a diagnostic interrupt to the specified Amazon EC2 instance to trigger a _kernel panic_ (on Linux instances), or a _blue screen_/_stop error_ (on Windows instances). For instances based on Intel and AMD processors, the interrupt is received as a _non-maskable interrupt_ (NMI).
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.SendDiagnosticInterruptRequest,
          _i2.SendDiagnosticInterruptRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.SendDiagnosticInterruptRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.SendDiagnosticInterruptRequest input, {
