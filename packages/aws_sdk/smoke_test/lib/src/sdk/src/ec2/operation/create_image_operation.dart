...
class CreateImageOperation extends _i1.HttpOperation<_i2.CreateImageRequest,
    _i2.CreateImageRequest, _i3.CreateImageResult, _i3.CreateImageResult> {
  /// Creates an Amazon EBS-backed AMI from an Amazon EBS-backed instance that is either running or stopped.
  ///
  /// By default, when Amazon EC2 creates the new AMI, it reboots the instance so that it can take snapshots of the attached volumes while data is at rest, in order to ensure a consistent state. You can set the `NoReboot` parameter to `true` in the API request, or use the `--no-reboot` option in the CLI to prevent Amazon EC2 from shutting down and rebooting the instance.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateImageRequest, _i2.CreateImageRequest,
          _i3.CreateImageResult, _i3.CreateImageResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateImageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateImageResult? output]) => 200;
  @override
  _i3.CreateImageResult buildOutput(
    _i3.CreateImageResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateImageResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateImageResult> run(
    _i2.CreateImageRequest input, {
