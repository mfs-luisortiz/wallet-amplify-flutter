...
class ListImagesInRecycleBinOperation extends _i1.PaginatedHttpOperation<
    _i2.ListImagesInRecycleBinRequest,
    _i2.ListImagesInRecycleBinRequest,
    _i3.ListImagesInRecycleBinResult,
    _i3.ListImagesInRecycleBinResult,
    String,
    int,
    _i4.BuiltList<_i5.ImageRecycleBinInfo>> {
  /// Lists one or more AMIs that are currently in the Recycle Bin. For more information, see [Recycle Bin](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/recycle-bin.html) in the Amazon Elastic Compute Cloud User Guide.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListImagesInRecycleBinRequest,
          _i3.ListImagesInRecycleBinResult,
          _i3.ListImagesInRecycleBinResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListImagesInRecycleBinRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListImagesInRecycleBinResult? output]) => 200;
  @override
  _i3.ListImagesInRecycleBinResult buildOutput(
    _i3.ListImagesInRecycleBinResult payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ListImagesInRecycleBinResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListImagesInRecycleBinResult> run(
    _i2.ListImagesInRecycleBinRequest input, {
  ...
  @override
  String? getToken(_i3.ListImagesInRecycleBinResult output) => output.nextToken;
  @override
  _i4.BuiltList<_i5.ImageRecycleBinInfo> getItems(
          _i3.ListImagesInRecycleBinResult output) =>
      output.images ?? _i4.BuiltList();
  @override
  _i2.ListImagesInRecycleBinRequest rebuildInput(
    _i2.ListImagesInRecycleBinRequest input,
    String token,
    int? pageSize,
  ) =>
