...
class ModifyReservedInstancesOperation extends _i1.HttpOperation<
    _i2.ModifyReservedInstancesRequest,
    _i2.ModifyReservedInstancesRequest,
    _i3.ModifyReservedInstancesResult,
    _i3.ModifyReservedInstancesResult> {
  /// Modifies the configuration of your Reserved Instances, such as the Availability Zone, instance count, or instance type. The Reserved Instances to be modified must be identical, except for Availability Zone, network platform, and instance type.
  ///
  /// For more information, see [Modifying Reserved Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-modifying.html) in the _Amazon EC2 User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyReservedInstancesRequest,
          _i3.ModifyReservedInstancesResult,
          _i3.ModifyReservedInstancesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ModifyReservedInstancesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ModifyReservedInstancesResult? output]) => 200;
  @override
  _i3.ModifyReservedInstancesResult buildOutput(
    _i3.ModifyReservedInstancesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyReservedInstancesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyReservedInstancesResult> run(
    _i2.ModifyReservedInstancesRequest input, {
