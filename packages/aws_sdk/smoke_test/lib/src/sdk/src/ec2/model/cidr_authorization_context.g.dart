...
class _$CidrAuthorizationContext extends CidrAuthorizationContext {
  ...
  _$CidrAuthorizationContext._({required this.message, required this.signature})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        message, r'CidrAuthorizationContext', 'message');
    BuiltValueNullFieldError.checkNotNull(
        signature, r'CidrAuthorizationContext', 'signature');
  }
...
class CidrAuthorizationContextBuilder
  ...
  CidrAuthorizationContextBuilder() {
    CidrAuthorizationContext._init(this);
  }
