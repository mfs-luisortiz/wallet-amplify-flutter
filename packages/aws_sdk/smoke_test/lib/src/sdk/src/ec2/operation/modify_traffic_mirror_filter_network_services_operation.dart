...
class ModifyTrafficMirrorFilterNetworkServicesOperation
    extends _i1.HttpOperation<
        _i2.ModifyTrafficMirrorFilterNetworkServicesRequest,
        _i2.ModifyTrafficMirrorFilterNetworkServicesRequest,
        _i3.ModifyTrafficMirrorFilterNetworkServicesResult,
        _i3.ModifyTrafficMirrorFilterNetworkServicesResult> {
  /// Allows or restricts mirroring network services.
  ///
  /// By default, Amazon DNS network services are not eligible for Traffic Mirror. Use `AddNetworkServices` to add network services to a Traffic Mirror filter. When a network service is added to the Traffic Mirror filter, all traffic related to that network service will be mirrored. When you no longer want to mirror network services, use `RemoveNetworkServices` to remove the network services from the Traffic Mirror filter.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyTrafficMirrorFilterNetworkServicesRequest,
          _i3.ModifyTrafficMirrorFilterNetworkServicesResult,
          _i3.ModifyTrafficMirrorFilterNetworkServicesResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.ModifyTrafficMirrorFilterNetworkServicesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode(
          [_i3.ModifyTrafficMirrorFilterNetworkServicesResult? output]) =>
      200;
  @override
  _i3.ModifyTrafficMirrorFilterNetworkServicesResult buildOutput(
    _i3.ModifyTrafficMirrorFilterNetworkServicesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyTrafficMirrorFilterNetworkServicesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyTrafficMirrorFilterNetworkServicesResult> run(
    _i2.ModifyTrafficMirrorFilterNetworkServicesRequest input, {
