...
abstract class ImportSnapshotRequest
  ...
  factory ImportSnapshotRequest({
    ...
    String? clientToken,
    String? description,
    _i4.SnapshotDiskContainer? diskContainer,
    bool? dryRun,
    bool? encrypted,
    String? kmsKeyId,
    String? roleName,
  ...
  _i4.SnapshotDiskContainer? get diskContainer;
      ...
      switch (key) {
        ...
        case 'DiskContainer':
          result.diskContainer.replace((serializers.deserialize(
            value,
            specifiedType: const FullType(_i4.SnapshotDiskContainer),
          ) as _i4.SnapshotDiskContainer));
        case 'DryRun':
