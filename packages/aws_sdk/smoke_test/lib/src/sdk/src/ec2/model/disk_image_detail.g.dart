...
class _$DiskImageDetail extends DiskImageDetail {
  ...
  @override
  final _i3.DiskImageFormat format;
  @override
  ...
  _$DiskImageDetail._(
    ...
    BuiltValueNullFieldError.checkNotNull(format, r'DiskImageDetail', 'format');
    BuiltValueNullFieldError.checkNotNull(
        importManifestUrl, r'DiskImageDetail', 'importManifestUrl');
  }
...
class DiskImageDetailBuilder
  ...
  _i3.DiskImageFormat? _format;
  _i3.DiskImageFormat? get format => _$this._format;
  set format(_i3.DiskImageFormat? format) => _$this._format = format;
    ...
    final _$result = _$v ??
        new _$DiskImageDetail._(
            ...
            format: BuiltValueNullFieldError.checkNotNull(
                format, r'DiskImageDetail', 'format'),
            importManifestUrl: BuiltValueNullFieldError.checkNotNull(
                importManifestUrl, r'DiskImageDetail', 'importManifestUrl'));
    replace(_$result);
    return _$result;
  }
