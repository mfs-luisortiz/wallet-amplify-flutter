...
class CreateTransitGatewayPeeringAttachmentOperation extends _i1.HttpOperation<
    _i2.CreateTransitGatewayPeeringAttachmentRequest,
    _i2.CreateTransitGatewayPeeringAttachmentRequest,
    _i3.CreateTransitGatewayPeeringAttachmentResult,
    _i3.CreateTransitGatewayPeeringAttachmentResult> {
  /// Requests a transit gateway peering attachment between the specified transit gateway (requester) and a peer transit gateway (accepter). The peer transit gateway can be in your account or a different Amazon Web Services account.
  ///
  /// After you create the peering attachment, the owner of the accepter transit gateway must accept the attachment request.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateTransitGatewayPeeringAttachmentRequest,
          _i3.CreateTransitGatewayPeeringAttachmentResult,
          _i3.CreateTransitGatewayPeeringAttachmentResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.CreateTransitGatewayPeeringAttachmentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateTransitGatewayPeeringAttachmentResult? output]) =>
      200;
  @override
  _i3.CreateTransitGatewayPeeringAttachmentResult buildOutput(
    _i3.CreateTransitGatewayPeeringAttachmentResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateTransitGatewayPeeringAttachmentResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateTransitGatewayPeeringAttachmentResult> run(
    _i2.CreateTransitGatewayPeeringAttachmentRequest input, {
