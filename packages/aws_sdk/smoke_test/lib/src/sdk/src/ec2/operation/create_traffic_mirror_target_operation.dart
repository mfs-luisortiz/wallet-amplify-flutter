...
class CreateTrafficMirrorTargetOperation extends _i1.HttpOperation<
    _i2.CreateTrafficMirrorTargetRequest,
    _i2.CreateTrafficMirrorTargetRequest,
    _i3.CreateTrafficMirrorTargetResult,
    _i3.CreateTrafficMirrorTargetResult> {
  /// Creates a target for your Traffic Mirror session.
  ///
  /// A Traffic Mirror target is the destination for mirrored traffic. The Traffic Mirror source and the Traffic Mirror target (monitoring appliances) can be in the same VPC, or in different VPCs connected via VPC peering or a transit gateway.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateTrafficMirrorTargetRequest,
          _i3.CreateTrafficMirrorTargetResult,
          _i3.CreateTrafficMirrorTargetResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateTrafficMirrorTargetRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateTrafficMirrorTargetResult? output]) => 200;
  @override
  _i3.CreateTrafficMirrorTargetResult buildOutput(
    _i3.CreateTrafficMirrorTargetResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateTrafficMirrorTargetResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateTrafficMirrorTargetResult> run(
    _i2.CreateTrafficMirrorTargetRequest input, {
