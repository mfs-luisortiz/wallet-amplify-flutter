...
class _$CreateTransitGatewayConnectRequestOptions
  ...
  _$CreateTransitGatewayConnectRequestOptions._({required this.protocol})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        protocol, r'CreateTransitGatewayConnectRequestOptions', 'protocol');
  }
...
class CreateTransitGatewayConnectRequestOptionsBuilder
  ...
  CreateTransitGatewayConnectRequestOptionsBuilder() {
    CreateTransitGatewayConnectRequestOptions._init(this);
  }
  ...
  _$CreateTransitGatewayConnectRequestOptions _build() {
    final _$result = _$v ??
        new _$CreateTransitGatewayConnectRequestOptions._(
            protocol: BuiltValueNullFieldError.checkNotNull(protocol,
                r'CreateTransitGatewayConnectRequestOptions', 'protocol'));
    replace(_$result);
    return _$result;
  }
}
