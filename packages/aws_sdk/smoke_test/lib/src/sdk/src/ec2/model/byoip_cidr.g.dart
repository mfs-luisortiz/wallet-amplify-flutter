...
class _$ByoipCidr extends ByoipCidr {
  ...
  @override
  final _i2.ByoipCidrState? state;
...
class ByoipCidrBuilder implements Builder<ByoipCidr, ByoipCidrBuilder> {
  ...
  _i2.ByoipCidrState? _state;
  _i2.ByoipCidrState? get state => _$this._state;
  set state(_i2.ByoipCidrState? state) => _$this._state = state;

  ByoipCidrBuilder() {
    ByoipCidr._init(this);
  }
