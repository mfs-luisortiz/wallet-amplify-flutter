...
class _$DescribeSnapshotAttributeRequest
  ...
  _$DescribeSnapshotAttributeRequest._(
      {required this.attribute, required this.snapshotId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attribute, r'DescribeSnapshotAttributeRequest', 'attribute');
    BuiltValueNullFieldError.checkNotNull(
        snapshotId, r'DescribeSnapshotAttributeRequest', 'snapshotId');
    BuiltValueNullFieldError.checkNotNull(
