...
class CreateInstanceEventWindowOperation extends _i1.HttpOperation<
    _i2.CreateInstanceEventWindowRequest,
    _i2.CreateInstanceEventWindowRequest,
    _i3.CreateInstanceEventWindowResult,
    _i3.CreateInstanceEventWindowResult> {
  /// Creates an event window in which scheduled events for the associated Amazon EC2 instances can run.
  ///
  /// You can define either a set of time ranges or a cron expression when creating the event window, but not both. All event window times are in UTC.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateInstanceEventWindowRequest,
          _i3.CreateInstanceEventWindowResult,
          _i3.CreateInstanceEventWindowResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateInstanceEventWindowRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateInstanceEventWindowResult? output]) => 200;
  @override
  _i3.CreateInstanceEventWindowResult buildOutput(
    _i3.CreateInstanceEventWindowResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateInstanceEventWindowResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateInstanceEventWindowResult> run(
    _i2.CreateInstanceEventWindowRequest input, {
