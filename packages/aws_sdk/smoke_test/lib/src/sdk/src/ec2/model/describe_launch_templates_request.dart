...
abstract class DescribeLaunchTemplatesRequest
  ...
  factory DescribeLaunchTemplatesRequest({
    ...
    return _$DescribeLaunchTemplatesRequest._(
      dryRun: dryRun,
      launchTemplateIds:
          launchTemplateIds == null ? null : _i4.BuiltList(launchTemplateIds),
      launchTemplateNames: launchTemplateNames == null
          ? null
          : _i4.BuiltList(launchTemplateNames),
  ...
  static const List<_i1.SmithySerializer> serializers = [
    DescribeLaunchTemplatesRequestEc2QuerySerializer()
  ];
  ...
  _i4.BuiltList<String>? get launchTemplateIds;

  /// One or more launch template names.
  _i4.BuiltList<String>? get launchTemplateNames;
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper('DescribeLaunchTemplatesRequest');
    helper.add(
      'dryRun',
      dryRun,
    );
