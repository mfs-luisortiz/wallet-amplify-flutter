...
import 'package:smoke_test/src/sdk/src/ec2/model/storage.dart' as _i3;
      ...
      switch (key) {
        ...
        case 'Storage':
          result.storage.replace((serializers.deserialize(
            value,
            specifiedType: const FullType(_i3.Storage),
          ) as _i3.Storage));
        case 'dryRun':
