...
class ProvisionIpamPoolCidrOperation extends _i1.HttpOperation<
    _i2.ProvisionIpamPoolCidrRequest,
    _i2.ProvisionIpamPoolCidrRequest,
    _i3.ProvisionIpamPoolCidrResult,
    _i3.ProvisionIpamPoolCidrResult> {
  /// Provision a CIDR to an IPAM pool. You can use this action to provision new CIDRs to a top-level pool or to transfer a CIDR from a top-level pool to a pool within it.
  ///
  /// For more information, see [Provision CIDRs to pools](https://docs.aws.amazon.com/vpc/latest/ipam/prov-cidr-ipam.html) in the _Amazon VPC IPAM User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ProvisionIpamPoolCidrRequest,
          _i3.ProvisionIpamPoolCidrResult,
          _i3.ProvisionIpamPoolCidrResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ProvisionIpamPoolCidrRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ProvisionIpamPoolCidrResult? output]) => 200;
  @override
  _i3.ProvisionIpamPoolCidrResult buildOutput(
    _i3.ProvisionIpamPoolCidrResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ProvisionIpamPoolCidrResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ProvisionIpamPoolCidrResult> run(
    _i2.ProvisionIpamPoolCidrRequest input, {
