...
class CreateLocalGatewayRouteOperation extends _i1.HttpOperation<
    _i2.CreateLocalGatewayRouteRequest,
    _i2.CreateLocalGatewayRouteRequest,
    _i3.CreateLocalGatewayRouteResult,
    _i3.CreateLocalGatewayRouteResult> {
  /// Creates a static route for the specified local gateway route table. You must specify one of the following targets:
  ///
  /// *   `LocalGatewayVirtualInterfaceGroupId`
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateLocalGatewayRouteRequest,
          _i3.CreateLocalGatewayRouteResult,
          _i3.CreateLocalGatewayRouteResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateLocalGatewayRouteRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateLocalGatewayRouteResult? output]) => 200;
  @override
  _i3.CreateLocalGatewayRouteResult buildOutput(
    _i3.CreateLocalGatewayRouteResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateLocalGatewayRouteResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateLocalGatewayRouteResult> run(
    _i2.CreateLocalGatewayRouteRequest input, {
