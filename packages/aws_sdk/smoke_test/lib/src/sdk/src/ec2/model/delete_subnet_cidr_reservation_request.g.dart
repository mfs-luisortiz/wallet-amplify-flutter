...
class _$DeleteSubnetCidrReservationRequest
  ...
  _$DeleteSubnetCidrReservationRequest._(
      {required this.subnetCidrReservationId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(subnetCidrReservationId,
        r'DeleteSubnetCidrReservationRequest', 'subnetCidrReservationId');
  ...
  _$DeleteSubnetCidrReservationRequest _build() {
    final _$result = _$v ??
        new _$DeleteSubnetCidrReservationRequest._(
            subnetCidrReservationId: BuiltValueNullFieldError.checkNotNull(
                subnetCidrReservationId,
                r'DeleteSubnetCidrReservationRequest',
                'subnetCidrReservationId'),
