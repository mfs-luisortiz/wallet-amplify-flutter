...
class _$DeleteCustomerGatewayRequest extends DeleteCustomerGatewayRequest {
  ...
  _$DeleteCustomerGatewayRequest._(
      {required this.customerGatewayId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(customerGatewayId,
        r'DeleteCustomerGatewayRequest', 'customerGatewayId');
    ...
    final _$result = _$v ??
        new _$DeleteCustomerGatewayRequest._(
            customerGatewayId: BuiltValueNullFieldError.checkNotNull(
                customerGatewayId,
                r'DeleteCustomerGatewayRequest',
                'customerGatewayId'),
