...
class _$InstanceStorageInfo extends InstanceStorageInfo {
  ...
  @override
  final _i6.BuiltList<_i3.DiskInfo>? disks;
  @override
  final _i4.EphemeralNvmeSupport? nvmeSupport;
  @override
  final _i5.InstanceStorageEncryptionSupport? encryptionSupport;
...
class InstanceStorageInfoBuilder
  ...
  _i6.ListBuilder<_i3.DiskInfo>? _disks;
  _i6.ListBuilder<_i3.DiskInfo> get disks =>
      _$this._disks ??= new _i6.ListBuilder<_i3.DiskInfo>();
  set disks(_i6.ListBuilder<_i3.DiskInfo>? disks) => _$this._disks = disks;

  _i4.EphemeralNvmeSupport? _nvmeSupport;
  _i4.EphemeralNvmeSupport? get nvmeSupport => _$this._nvmeSupport;
  set nvmeSupport(_i4.EphemeralNvmeSupport? nvmeSupport) =>
      _$this._nvmeSupport = nvmeSupport;

  _i5.InstanceStorageEncryptionSupport? _encryptionSupport;
  _i5.InstanceStorageEncryptionSupport? get encryptionSupport =>
      _$this._encryptionSupport;
  set encryptionSupport(
  ...
  InstanceStorageInfoBuilder() {
    InstanceStorageInfo._init(this);
  }
