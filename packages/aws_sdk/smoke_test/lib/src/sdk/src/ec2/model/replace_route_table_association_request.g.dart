...
class _$ReplaceRouteTableAssociationRequest
  ...
  _$ReplaceRouteTableAssociationRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        associationId, r'ReplaceRouteTableAssociationRequest', 'associationId');
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'ReplaceRouteTableAssociationRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        routeTableId, r'ReplaceRouteTableAssociationRequest', 'routeTableId');
  }
    ...
    final _$result = _$v ??
        new _$ReplaceRouteTableAssociationRequest._(
            associationId: BuiltValueNullFieldError.checkNotNull(associationId,
                r'ReplaceRouteTableAssociationRequest', 'associationId'),
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'ReplaceRouteTableAssociationRequest', 'dryRun'),
            routeTableId: BuiltValueNullFieldError.checkNotNull(routeTableId,
                r'ReplaceRouteTableAssociationRequest', 'routeTableId'));
    replace(_$result);
    return _$result;
  }
}
