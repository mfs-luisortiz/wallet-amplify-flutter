...
class _$AssociateTrunkInterfaceRequest extends AssociateTrunkInterfaceRequest {
  ...
  _$AssociateTrunkInterfaceRequest._(
      {required this.branchInterfaceId,
      required this.trunkInterfaceId,
      required this.vlanId,
      required this.greKey,
      this.clientToken,
      required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(branchInterfaceId,
        r'AssociateTrunkInterfaceRequest', 'branchInterfaceId');
    BuiltValueNullFieldError.checkNotNull(trunkInterfaceId,
        r'AssociateTrunkInterfaceRequest', 'trunkInterfaceId');
  ...
  _$AssociateTrunkInterfaceRequest _build() {
    final _$result = _$v ??
        new _$AssociateTrunkInterfaceRequest._(
            branchInterfaceId: BuiltValueNullFieldError.checkNotNull(
                branchInterfaceId,
                r'AssociateTrunkInterfaceRequest',
                'branchInterfaceId'),
            trunkInterfaceId: BuiltValueNullFieldError.checkNotNull(
                trunkInterfaceId,
                r'AssociateTrunkInterfaceRequest',
                'trunkInterfaceId'),
