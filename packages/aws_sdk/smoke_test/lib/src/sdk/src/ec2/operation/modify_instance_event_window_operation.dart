...
class ModifyInstanceEventWindowOperation extends _i1.HttpOperation<
    _i2.ModifyInstanceEventWindowRequest,
    _i2.ModifyInstanceEventWindowRequest,
    _i3.ModifyInstanceEventWindowResult,
    _i3.ModifyInstanceEventWindowResult> {
  /// Modifies the specified event window.
  ///
  /// You can define either a set of time ranges or a cron expression when modifying the event window, but not both.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyInstanceEventWindowRequest,
          _i3.ModifyInstanceEventWindowResult,
          _i3.ModifyInstanceEventWindowResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ModifyInstanceEventWindowRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ModifyInstanceEventWindowResult? output]) => 200;
  @override
  _i3.ModifyInstanceEventWindowResult buildOutput(
    _i3.ModifyInstanceEventWindowResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyInstanceEventWindowResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyInstanceEventWindowResult> run(
    _i2.ModifyInstanceEventWindowRequest input, {
