...
class _$DescribeVolumeAttributeRequest extends DescribeVolumeAttributeRequest {
  @override
  final _i3.VolumeAttributeName attribute;
  @override
  ...
  _$DescribeVolumeAttributeRequest._(
      {required this.attribute, required this.volumeId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        attribute, r'DescribeVolumeAttributeRequest', 'attribute');
    BuiltValueNullFieldError.checkNotNull(
        volumeId, r'DescribeVolumeAttributeRequest', 'volumeId');
    BuiltValueNullFieldError.checkNotNull(
...
class DescribeVolumeAttributeRequestBuilder
  ...
  _i3.VolumeAttributeName? _attribute;
  _i3.VolumeAttributeName? get attribute => _$this._attribute;
  set attribute(_i3.VolumeAttributeName? attribute) =>
