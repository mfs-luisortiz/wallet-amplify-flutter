...
class _$DescribeNetworkInterfaceAttributeRequest
  ...
  @override
  final _i3.NetworkInterfaceAttribute? attribute;
  @override
  final bool dryRun;
  @override
  ...
  _$DescribeNetworkInterfaceAttributeRequest._(
      {this.attribute, required this.dryRun, required this.networkInterfaceId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DescribeNetworkInterfaceAttributeRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(networkInterfaceId,
        r'DescribeNetworkInterfaceAttributeRequest', 'networkInterfaceId');
  }
...
class DescribeNetworkInterfaceAttributeRequestBuilder
  ...
  _i3.NetworkInterfaceAttribute? _attribute;
  _i3.NetworkInterfaceAttribute? get attribute => _$this._attribute;
  set attribute(_i3.NetworkInterfaceAttribute? attribute) =>
    ...
    final _$result = _$v ??
        new _$DescribeNetworkInterfaceAttributeRequest._(
            ...
            networkInterfaceId: BuiltValueNullFieldError.checkNotNull(
                networkInterfaceId,
                r'DescribeNetworkInterfaceAttributeRequest',
                'networkInterfaceId'));
    replace(_$result);
    return _$result;
  }
