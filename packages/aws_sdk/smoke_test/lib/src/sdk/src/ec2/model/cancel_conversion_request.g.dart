...
class _$CancelConversionRequest extends CancelConversionRequest {
  ...
  _$CancelConversionRequest._(
      {required this.conversionTaskId,
      required this.dryRun,
      this.reasonMessage})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        conversionTaskId, r'CancelConversionRequest', 'conversionTaskId');
    BuiltValueNullFieldError.checkNotNull(
  ...
  _$CancelConversionRequest _build() {
    final _$result = _$v ??
        new _$CancelConversionRequest._(
            conversionTaskId: BuiltValueNullFieldError.checkNotNull(
                conversionTaskId,
                r'CancelConversionRequest',
                'conversionTaskId'),
