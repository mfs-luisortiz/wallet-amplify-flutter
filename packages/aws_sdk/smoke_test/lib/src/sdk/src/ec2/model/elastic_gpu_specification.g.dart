...
class _$ElasticGpuSpecification extends ElasticGpuSpecification {
  ...
  _$ElasticGpuSpecification._({required this.type}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        type, r'ElasticGpuSpecification', 'type');
  }
...
class ElasticGpuSpecificationBuilder
  ...
  ElasticGpuSpecificationBuilder() {
    ElasticGpuSpecification._init(this);
  }
  ...
  _$ElasticGpuSpecification _build() {
    final _$result = _$v ??
        new _$ElasticGpuSpecification._(
