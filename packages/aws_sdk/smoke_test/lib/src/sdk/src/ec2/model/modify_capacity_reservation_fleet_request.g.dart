...
class _$ModifyCapacityReservationFleetRequest
  ...
  _$ModifyCapacityReservationFleetRequest._(
      {required this.capacityReservationFleetId,
      required this.totalTargetCapacity,
      this.endDate,
      required this.dryRun,
      required this.removeEndDate})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(capacityReservationFleetId,
        r'ModifyCapacityReservationFleetRequest', 'capacityReservationFleetId');
  ...
  _$ModifyCapacityReservationFleetRequest _build() {
    final _$result = _$v ??
        new _$ModifyCapacityReservationFleetRequest._(
            capacityReservationFleetId: BuiltValueNullFieldError.checkNotNull(
