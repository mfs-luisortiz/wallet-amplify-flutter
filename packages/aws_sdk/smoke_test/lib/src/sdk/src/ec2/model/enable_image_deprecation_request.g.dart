...
class _$EnableImageDeprecationRequest extends EnableImageDeprecationRequest {
  ...
  _$EnableImageDeprecationRequest._(
      {required this.imageId, required this.deprecateAt, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        imageId, r'EnableImageDeprecationRequest', 'imageId');
    BuiltValueNullFieldError.checkNotNull(
        deprecateAt, r'EnableImageDeprecationRequest', 'deprecateAt');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$EnableImageDeprecationRequest._(
            imageId: BuiltValueNullFieldError.checkNotNull(
                imageId, r'EnableImageDeprecationRequest', 'imageId'),
            deprecateAt: BuiltValueNullFieldError.checkNotNull(
                deprecateAt, r'EnableImageDeprecationRequest', 'deprecateAt'),
