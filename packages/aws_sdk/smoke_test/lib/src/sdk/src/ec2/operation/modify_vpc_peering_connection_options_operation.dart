...
class ModifyVpcPeeringConnectionOptionsOperation extends _i1.HttpOperation<
    _i2.ModifyVpcPeeringConnectionOptionsRequest,
    _i2.ModifyVpcPeeringConnectionOptionsRequest,
    _i3.ModifyVpcPeeringConnectionOptionsResult,
    _i3.ModifyVpcPeeringConnectionOptionsResult> {
  /// We are retiring EC2-Classic. We recommend that you migrate from EC2-Classic to a VPC. For more information, see [Migrate from EC2-Classic to a VPC](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/vpc-migrate.html) in the _Amazon Elastic Compute Cloud User Guide_.
  ///
  /// Modifies the VPC peering connection options on one side of a VPC peering connection. You can do the following:
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyVpcPeeringConnectionOptionsRequest,
          _i3.ModifyVpcPeeringConnectionOptionsResult,
          _i3.ModifyVpcPeeringConnectionOptionsResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.ModifyVpcPeeringConnectionOptionsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ModifyVpcPeeringConnectionOptionsResult? output]) => 200;
  @override
  _i3.ModifyVpcPeeringConnectionOptionsResult buildOutput(
    _i3.ModifyVpcPeeringConnectionOptionsResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyVpcPeeringConnectionOptionsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyVpcPeeringConnectionOptionsResult> run(
    _i2.ModifyVpcPeeringConnectionOptionsRequest input, {
