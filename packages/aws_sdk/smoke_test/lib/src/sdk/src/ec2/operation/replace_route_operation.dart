...
class ReplaceRouteOperation extends _i1.HttpOperation<_i2.ReplaceRouteRequest,
    _i2.ReplaceRouteRequest, _i1.Unit, _i1.Unit> {
  /// Replaces an existing route within a route table in a VPC.
  ///
  /// You must specify either a destination CIDR block or a prefix list ID. You must also specify exactly one of the resources from the parameter list, or reset the local route to its default target.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.ReplaceRouteRequest, _i2.ReplaceRouteRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ReplaceRouteRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
