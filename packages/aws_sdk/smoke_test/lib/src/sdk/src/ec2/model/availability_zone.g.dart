...
class _$AvailabilityZone extends AvailabilityZone {
  @override
  final _i2.AvailabilityZoneState? state;
  @override
  final _i3.AvailabilityZoneOptInStatus? optInStatus;
  @override
  final _i5.BuiltList<_i4.AvailabilityZoneMessage>? messages;
  @override
...
class AvailabilityZoneBuilder
  ...
  _i2.AvailabilityZoneState? _state;
  _i2.AvailabilityZoneState? get state => _$this._state;
  set state(_i2.AvailabilityZoneState? state) => _$this._state = state;

  _i3.AvailabilityZoneOptInStatus? _optInStatus;
  _i3.AvailabilityZoneOptInStatus? get optInStatus => _$this._optInStatus;
  set optInStatus(_i3.AvailabilityZoneOptInStatus? optInStatus) =>
      _$this._optInStatus = optInStatus;

  _i5.ListBuilder<_i4.AvailabilityZoneMessage>? _messages;
  _i5.ListBuilder<_i4.AvailabilityZoneMessage> get messages =>
      _$this._messages ??= new _i5.ListBuilder<_i4.AvailabilityZoneMessage>();
  set messages(_i5.ListBuilder<_i4.AvailabilityZoneMessage>? messages) =>
