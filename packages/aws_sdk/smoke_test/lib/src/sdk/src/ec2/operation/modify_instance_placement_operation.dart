...
class ModifyInstancePlacementOperation extends _i1.HttpOperation<
    _i2.ModifyInstancePlacementRequest,
    _i2.ModifyInstancePlacementRequest,
    _i3.ModifyInstancePlacementResult,
    _i3.ModifyInstancePlacementResult> {
  /// Modifies the placement attributes for a specified instance. You can do the following:
  ///
  /// *   Modify the affinity between an instance and a [Dedicated Host](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/dedicated-hosts-overview.html). When affinity is set to `host` and the instance is not associated with a specific Dedicated Host, the next time the instance is launched, it is automatically associated with the host on which it lands. If the instance is restarted or rebooted, this relationship persists.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ModifyInstancePlacementRequest,
          _i3.ModifyInstancePlacementResult,
          _i3.ModifyInstancePlacementResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ModifyInstancePlacementRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ModifyInstancePlacementResult? output]) => 200;
  @override
  _i3.ModifyInstancePlacementResult buildOutput(
    _i3.ModifyInstancePlacementResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ModifyInstancePlacementResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ModifyInstancePlacementResult> run(
    _i2.ModifyInstancePlacementRequest input, {
