...
class _$PurchaseScheduledInstancesRequest
  ...
  final bool dryRun;
  @override
  final _i4.BuiltList<_i3.PurchaseRequest> purchaseRequests;
  ...
  _$PurchaseScheduledInstancesRequest._(
      {this.clientToken, required this.dryRun, required this.purchaseRequests})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'PurchaseScheduledInstancesRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(purchaseRequests,
        r'PurchaseScheduledInstancesRequest', 'purchaseRequests');
  }
...
class PurchaseScheduledInstancesRequestBuilder
  ...
  _i4.ListBuilder<_i3.PurchaseRequest>? _purchaseRequests;
  _i4.ListBuilder<_i3.PurchaseRequest> get purchaseRequests =>
      _$this._purchaseRequests ??= new _i4.ListBuilder<_i3.PurchaseRequest>();
  set purchaseRequests(
          _i4.ListBuilder<_i3.PurchaseRequest>? purchaseRequests) =>
      ...
      _$result = _$v ??
          new _$PurchaseScheduledInstancesRequest._(
              ...
              dryRun: BuiltValueNullFieldError.checkNotNull(
                  dryRun, r'PurchaseScheduledInstancesRequest', 'dryRun'),
              purchaseRequests: purchaseRequests.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'purchaseRequests';
        purchaseRequests.build();
      } catch (e) {
