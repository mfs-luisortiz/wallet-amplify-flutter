...
class _$DeleteVpcRequest extends DeleteVpcRequest {
  ...
  _$DeleteVpcRequest._({required this.vpcId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vpcId, r'DeleteVpcRequest', 'vpcId');
    ...
    final _$result = _$v ??
        new _$DeleteVpcRequest._(
            vpcId: BuiltValueNullFieldError.checkNotNull(
                vpcId, r'DeleteVpcRequest', 'vpcId'),
