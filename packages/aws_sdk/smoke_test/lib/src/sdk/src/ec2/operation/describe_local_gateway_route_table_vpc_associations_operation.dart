...
class DescribeLocalGatewayRouteTableVpcAssociationsOperation
    extends _i1.PaginatedHttpOperation<
        _i2.DescribeLocalGatewayRouteTableVpcAssociationsRequest,
        _i2.DescribeLocalGatewayRouteTableVpcAssociationsRequest,
        _i3.DescribeLocalGatewayRouteTableVpcAssociationsResult,
        _i3.DescribeLocalGatewayRouteTableVpcAssociationsResult,
        String,
        int,
        _i4.BuiltList<_i5.LocalGatewayRouteTableVpcAssociation>> {
  /// Describes the specified associations between VPCs and local gateway route tables.
  ...
  _i1.HttpRequest buildRequest(
          _i2.DescribeLocalGatewayRouteTableVpcAssociationsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode(
          [_i3.DescribeLocalGatewayRouteTableVpcAssociationsResult? output]) =>
      200;
  @override
  _i3.DescribeLocalGatewayRouteTableVpcAssociationsResult buildOutput(
    _i3.DescribeLocalGatewayRouteTableVpcAssociationsResult payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeLocalGatewayRouteTableVpcAssociationsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeLocalGatewayRouteTableVpcAssociationsResult>
      run(
    _i2.DescribeLocalGatewayRouteTableVpcAssociationsRequest input, {
  ...
  String? getToken(
      ...
      output.nextToken;
  @override
  _i4.BuiltList<_i5.LocalGatewayRouteTableVpcAssociation> getItems(
          _i3.DescribeLocalGatewayRouteTableVpcAssociationsResult output) =>
      output.localGatewayRouteTableVpcAssociations ?? _i4.BuiltList();
  @override
  _i2.DescribeLocalGatewayRouteTableVpcAssociationsRequest rebuildInput(
    _i2.DescribeLocalGatewayRouteTableVpcAssociationsRequest input,
    String token,
    int? pageSize,
  ) =>
