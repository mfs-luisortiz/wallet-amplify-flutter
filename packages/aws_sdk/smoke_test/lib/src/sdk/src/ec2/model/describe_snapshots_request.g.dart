...
class _$DescribeSnapshotsRequest extends DescribeSnapshotsRequest {
  ...
  @override
  final _i4.BuiltList<String>? ownerIds;
  @override
  final _i4.BuiltList<String>? restorableByUserIds;
  @override
  final _i4.BuiltList<String>? snapshotIds;
  @override
  final bool dryRun;
...
class DescribeSnapshotsRequestBuilder
  ...
  _i4.ListBuilder<String>? _ownerIds;
  _i4.ListBuilder<String> get ownerIds =>
      _$this._ownerIds ??= new _i4.ListBuilder<String>();
  set ownerIds(_i4.ListBuilder<String>? ownerIds) =>
      _$this._ownerIds = ownerIds;

  _i4.ListBuilder<String>? _restorableByUserIds;
  _i4.ListBuilder<String> get restorableByUserIds =>
      _$this._restorableByUserIds ??= new _i4.ListBuilder<String>();
  set restorableByUserIds(_i4.ListBuilder<String>? restorableByUserIds) =>
      _$this._restorableByUserIds = restorableByUserIds;

  _i4.ListBuilder<String>? _snapshotIds;
  _i4.ListBuilder<String> get snapshotIds =>
      _$this._snapshotIds ??= new _i4.ListBuilder<String>();
  set snapshotIds(_i4.ListBuilder<String>? snapshotIds) =>
