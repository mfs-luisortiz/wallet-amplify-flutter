...
class _$CreateCarrierGatewayResult extends CreateCarrierGatewayResult {
  @override
  final _i2.CarrierGateway? carrierGateway;
...
class CreateCarrierGatewayResultBuilder
  ...
  _i2.CarrierGatewayBuilder? _carrierGateway;
  _i2.CarrierGatewayBuilder get carrierGateway =>
      _$this._carrierGateway ??= new _i2.CarrierGatewayBuilder();
  set carrierGateway(_i2.CarrierGatewayBuilder? carrierGateway) =>
      _$this._carrierGateway = carrierGateway;

  CreateCarrierGatewayResultBuilder() {
    CreateCarrierGatewayResult._init(this);
  }
