...
class _$DeleteInternetGatewayRequest extends DeleteInternetGatewayRequest {
  ...
  _$DeleteInternetGatewayRequest._(
      {required this.dryRun, required this.internetGatewayId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeleteInternetGatewayRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(internetGatewayId,
        r'DeleteInternetGatewayRequest', 'internetGatewayId');
  }
    ...
    final _$result = _$v ??
        new _$DeleteInternetGatewayRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'DeleteInternetGatewayRequest', 'dryRun'),
            internetGatewayId: BuiltValueNullFieldError.checkNotNull(
                internetGatewayId,
                r'DeleteInternetGatewayRequest',
                'internetGatewayId'));
    replace(_$result);
    return _$result;
  }
