...
class _$GetVpnConnectionDeviceSampleConfigurationRequest
  ...
  _$GetVpnConnectionDeviceSampleConfigurationRequest._(
      ...
      required this.vpnConnectionDeviceTypeId,
      this.internetKeyExchangeVersion,
      required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vpnConnectionId,
        r'GetVpnConnectionDeviceSampleConfigurationRequest', 'vpnConnectionId');
    BuiltValueNullFieldError.checkNotNull(
        vpnConnectionDeviceTypeId,
        r'GetVpnConnectionDeviceSampleConfigurationRequest',
        'vpnConnectionDeviceTypeId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$GetVpnConnectionDeviceSampleConfigurationRequest._(
            vpnConnectionId: BuiltValueNullFieldError.checkNotNull(
                ...
                r'GetVpnConnectionDeviceSampleConfigurationRequest',
                'vpnConnectionId'),
            vpnConnectionDeviceTypeId: BuiltValueNullFieldError.checkNotNull(
                vpnConnectionDeviceTypeId,
                r'GetVpnConnectionDeviceSampleConfigurationRequest',
                'vpnConnectionDeviceTypeId'),
