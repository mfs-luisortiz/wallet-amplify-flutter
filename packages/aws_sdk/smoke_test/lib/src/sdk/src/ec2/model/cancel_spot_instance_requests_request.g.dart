...
class _$CancelSpotInstanceRequestsRequest
  ...
  _$CancelSpotInstanceRequestsRequest._(
      {required this.dryRun, required this.spotInstanceRequestIds})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'CancelSpotInstanceRequestsRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(spotInstanceRequestIds,
        r'CancelSpotInstanceRequestsRequest', 'spotInstanceRequestIds');
  }
