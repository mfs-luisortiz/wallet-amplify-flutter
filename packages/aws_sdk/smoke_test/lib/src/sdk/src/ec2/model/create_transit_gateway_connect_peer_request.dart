...
abstract class CreateTransitGatewayConnectPeerRequest
  ...
  factory CreateTransitGatewayConnectPeerRequest({
    ...
    _i3.TransitGatewayConnectRequestBgpOptions? bgpOptions,
    ...
    return _$CreateTransitGatewayConnectPeerRequest._(
      ...
      insideCidrBlocks: _i5.BuiltList(insideCidrBlocks),
      tagSpecifications:
  ...
  _i3.TransitGatewayConnectRequestBgpOptions? get bgpOptions;
  ...
  _i5.BuiltList<String> get insideCidrBlocks;
      ...
      switch (key) {
        ...
        case 'BgpOptions':
          result.bgpOptions.replace((serializers.deserialize(
            value,
            specifiedType:
                const FullType(_i3.TransitGatewayConnectRequestBgpOptions),
          ) as _i3.TransitGatewayConnectRequestBgpOptions));
