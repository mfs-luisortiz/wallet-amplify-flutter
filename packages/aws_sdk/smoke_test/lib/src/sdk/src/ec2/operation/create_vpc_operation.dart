...
import 'package:smoke_test/src/sdk/src/ec2/model/create_vpc_request.dart'
    as _i2;
import 'package:smoke_test/src/sdk/src/ec2/model/create_vpc_result.dart' as _i3;
...
class CreateVpcOperation extends _i1.HttpOperation<_i2.CreateVpcRequest,
    _i2.CreateVpcRequest, _i3.CreateVpcResult, _i3.CreateVpcResult> {
  /// Creates a VPC with the specified IPv4 CIDR block. The smallest VPC you can create uses a /28 netmask (16 IPv4 addresses), and the largest uses a /16 netmask (65,536 IPv4 addresses). For more information about how large to make your VPC, see [Your VPC and subnets](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html) in the _Amazon Virtual Private Cloud User Guide_.
  ///
  /// You can optionally request an IPv6 CIDR block for the VPC. You can request an Amazon-provided IPv6 CIDR block from Amazon's pool of IPv6 addresses, or an IPv6 CIDR block from an IPv6 address pool that you provisioned through bring your own IP addresses ([BYOIP](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-byoip.html)).
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateVpcRequest, _i2.CreateVpcRequest,
          _i3.CreateVpcResult, _i3.CreateVpcResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateVpcRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateVpcResult? output]) => 200;
  @override
  _i3.CreateVpcResult buildOutput(
    _i3.CreateVpcResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateVpcResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateVpcResult> run(
    _i2.CreateVpcRequest input, {
