...
class _$AssociateDhcpOptionsRequest extends AssociateDhcpOptionsRequest {
  ...
  _$AssociateDhcpOptionsRequest._(
      {required this.dhcpOptionsId, required this.vpcId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dhcpOptionsId, r'AssociateDhcpOptionsRequest', 'dhcpOptionsId');
    BuiltValueNullFieldError.checkNotNull(
        vpcId, r'AssociateDhcpOptionsRequest', 'vpcId');
    BuiltValueNullFieldError.checkNotNull(
  ...
  _$AssociateDhcpOptionsRequest _build() {
    final _$result = _$v ??
        new _$AssociateDhcpOptionsRequest._(
            dhcpOptionsId: BuiltValueNullFieldError.checkNotNull(
                dhcpOptionsId, r'AssociateDhcpOptionsRequest', 'dhcpOptionsId'),
