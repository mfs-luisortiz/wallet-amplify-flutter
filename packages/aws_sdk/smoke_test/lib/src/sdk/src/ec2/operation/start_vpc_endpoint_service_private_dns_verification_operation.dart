...
class StartVpcEndpointServicePrivateDnsVerificationOperation
    extends _i1.HttpOperation<
        _i2.StartVpcEndpointServicePrivateDnsVerificationRequest,
        _i2.StartVpcEndpointServicePrivateDnsVerificationRequest,
        _i3.StartVpcEndpointServicePrivateDnsVerificationResult,
        _i3.StartVpcEndpointServicePrivateDnsVerificationResult> {
  /// Initiates the verification process to prove that the service provider owns the private DNS name domain for the endpoint service.
  ///
  /// The service provider must successfully perform the verification before the consumer can use the name to access the service.
  ...
  _i1.HttpRequest buildRequest(
          _i2.StartVpcEndpointServicePrivateDnsVerificationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode(
          [_i3.StartVpcEndpointServicePrivateDnsVerificationResult? output]) =>
      200;
  @override
  _i3.StartVpcEndpointServicePrivateDnsVerificationResult buildOutput(
    _i3.StartVpcEndpointServicePrivateDnsVerificationResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.StartVpcEndpointServicePrivateDnsVerificationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.StartVpcEndpointServicePrivateDnsVerificationResult>
      run(
    _i2.StartVpcEndpointServicePrivateDnsVerificationRequest input, {
