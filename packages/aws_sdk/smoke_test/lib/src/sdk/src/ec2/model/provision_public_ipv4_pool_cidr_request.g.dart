...
class _$ProvisionPublicIpv4PoolCidrRequest
  ...
  _$ProvisionPublicIpv4PoolCidrRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        ipamPoolId, r'ProvisionPublicIpv4PoolCidrRequest', 'ipamPoolId');
    BuiltValueNullFieldError.checkNotNull(
        poolId, r'ProvisionPublicIpv4PoolCidrRequest', 'poolId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$ProvisionPublicIpv4PoolCidrRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'ProvisionPublicIpv4PoolCidrRequest', 'dryRun'),
            ipamPoolId: BuiltValueNullFieldError.checkNotNull(ipamPoolId,
                r'ProvisionPublicIpv4PoolCidrRequest', 'ipamPoolId'),
