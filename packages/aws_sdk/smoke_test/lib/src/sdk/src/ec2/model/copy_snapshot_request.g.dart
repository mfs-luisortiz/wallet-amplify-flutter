...
class _$CopySnapshotRequest extends CopySnapshotRequest {
  ...
  _$CopySnapshotRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        sourceRegion, r'CopySnapshotRequest', 'sourceRegion');
    BuiltValueNullFieldError.checkNotNull(
        sourceSnapshotId, r'CopySnapshotRequest', 'sourceSnapshotId');
    BuiltValueNullFieldError.checkNotNull(
      ...
      _$result = _$v ??
          new _$CopySnapshotRequest._(
              ...
              sourceRegion: BuiltValueNullFieldError.checkNotNull(
                  sourceRegion, r'CopySnapshotRequest', 'sourceRegion'),
              sourceSnapshotId: BuiltValueNullFieldError.checkNotNull(
                  sourceSnapshotId, r'CopySnapshotRequest', 'sourceSnapshotId'),
