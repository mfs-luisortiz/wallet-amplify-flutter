...
class _$VpcEndpointConnection extends VpcEndpointConnection {
  ...
  @override
  final _i2.State? vpcEndpointState;
  @override
  final DateTime? creationTimestamp;
  @override
  final _i6.BuiltList<_i3.DnsEntry>? dnsEntries;
  @override
  final _i6.BuiltList<String>? networkLoadBalancerArns;
  @override
  final _i6.BuiltList<String>? gatewayLoadBalancerArns;
  @override
...
class VpcEndpointConnectionBuilder
  ...
  _i2.State? _vpcEndpointState;
  _i2.State? get vpcEndpointState => _$this._vpcEndpointState;
  set vpcEndpointState(_i2.State? vpcEndpointState) =>
  ...
  _i6.ListBuilder<_i3.DnsEntry>? _dnsEntries;
  _i6.ListBuilder<_i3.DnsEntry> get dnsEntries =>
      _$this._dnsEntries ??= new _i6.ListBuilder<_i3.DnsEntry>();
  set dnsEntries(_i6.ListBuilder<_i3.DnsEntry>? dnsEntries) =>
      _$this._dnsEntries = dnsEntries;

  _i6.ListBuilder<String>? _networkLoadBalancerArns;
  _i6.ListBuilder<String> get networkLoadBalancerArns =>
      _$this._networkLoadBalancerArns ??= new _i6.ListBuilder<String>();
  set networkLoadBalancerArns(
          _i6.ListBuilder<String>? networkLoadBalancerArns) =>
      _$this._networkLoadBalancerArns = networkLoadBalancerArns;

  _i6.ListBuilder<String>? _gatewayLoadBalancerArns;
  _i6.ListBuilder<String> get gatewayLoadBalancerArns =>
      _$this._gatewayLoadBalancerArns ??= new _i6.ListBuilder<String>();
  set gatewayLoadBalancerArns(
          _i6.ListBuilder<String>? gatewayLoadBalancerArns) =>
  ...
  VpcEndpointConnectionBuilder() {
    VpcEndpointConnection._init(this);
  }
