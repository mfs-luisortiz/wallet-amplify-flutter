...
class _$DetachVpnGatewayRequest extends DetachVpnGatewayRequest {
  ...
  _$DetachVpnGatewayRequest._(
      {required this.vpcId, required this.vpnGatewayId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        vpcId, r'DetachVpnGatewayRequest', 'vpcId');
    BuiltValueNullFieldError.checkNotNull(
        vpnGatewayId, r'DetachVpnGatewayRequest', 'vpnGatewayId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$DetachVpnGatewayRequest._(
            vpcId: BuiltValueNullFieldError.checkNotNull(
                vpcId, r'DetachVpnGatewayRequest', 'vpcId'),
            vpnGatewayId: BuiltValueNullFieldError.checkNotNull(
                vpnGatewayId, r'DetachVpnGatewayRequest', 'vpnGatewayId'),
