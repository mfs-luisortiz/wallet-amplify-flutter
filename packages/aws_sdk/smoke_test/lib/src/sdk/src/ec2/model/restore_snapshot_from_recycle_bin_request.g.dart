...
class _$RestoreSnapshotFromRecycleBinRequest
  ...
  _$RestoreSnapshotFromRecycleBinRequest._(
      {required this.snapshotId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        snapshotId, r'RestoreSnapshotFromRecycleBinRequest', 'snapshotId');
    BuiltValueNullFieldError.checkNotNull(
  ...
  _$RestoreSnapshotFromRecycleBinRequest _build() {
    final _$result = _$v ??
        new _$RestoreSnapshotFromRecycleBinRequest._(
            snapshotId: BuiltValueNullFieldError.checkNotNull(snapshotId,
                r'RestoreSnapshotFromRecycleBinRequest', 'snapshotId'),
