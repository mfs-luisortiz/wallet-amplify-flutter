...
class _$ClientVpnConnection extends ClientVpnConnection {
  ...
  @override
  final _i2.ClientVpnConnectionStatus? status;
  @override
  final String? connectionEndTime;
  @override
  final _i3.BuiltList<String>? postureComplianceStatuses;
...
class ClientVpnConnectionBuilder
  ...
  _i2.ClientVpnConnectionStatusBuilder? _status;
  _i2.ClientVpnConnectionStatusBuilder get status =>
      _$this._status ??= new _i2.ClientVpnConnectionStatusBuilder();
  set status(_i2.ClientVpnConnectionStatusBuilder? status) =>
  ...
  _i3.ListBuilder<String>? _postureComplianceStatuses;
  _i3.ListBuilder<String> get postureComplianceStatuses =>
      _$this._postureComplianceStatuses ??= new _i3.ListBuilder<String>();
  set postureComplianceStatuses(
          _i3.ListBuilder<String>? postureComplianceStatuses) =>
      _$this._postureComplianceStatuses = postureComplianceStatuses;

  ClientVpnConnectionBuilder() {
    ClientVpnConnection._init(this);
  }
