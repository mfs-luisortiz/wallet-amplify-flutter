...
class AcceptTransitGatewayVpcAttachmentOperation extends _i1.HttpOperation<
    _i2.AcceptTransitGatewayVpcAttachmentRequest,
    _i2.AcceptTransitGatewayVpcAttachmentRequest,
    _i3.AcceptTransitGatewayVpcAttachmentResult,
    _i3.AcceptTransitGatewayVpcAttachmentResult> {
  /// Accepts a request to attach a VPC to a transit gateway.
  ///
  /// The VPC attachment must be in the `pendingAcceptance` state. Use DescribeTransitGatewayVpcAttachments to view your pending VPC attachment requests. Use RejectTransitGatewayVpcAttachment to reject a VPC attachment request.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.AcceptTransitGatewayVpcAttachmentRequest,
          _i3.AcceptTransitGatewayVpcAttachmentResult,
          _i3.AcceptTransitGatewayVpcAttachmentResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.AcceptTransitGatewayVpcAttachmentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.AcceptTransitGatewayVpcAttachmentResult? output]) => 200;
  @override
  _i3.AcceptTransitGatewayVpcAttachmentResult buildOutput(
    _i3.AcceptTransitGatewayVpcAttachmentResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.AcceptTransitGatewayVpcAttachmentResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.AcceptTransitGatewayVpcAttachmentResult> run(
    _i2.AcceptTransitGatewayVpcAttachmentRequest input, {
