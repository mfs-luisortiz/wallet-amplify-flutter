...
class _$DeleteCoipCidrRequest extends DeleteCoipCidrRequest {
  ...
  _$DeleteCoipCidrRequest._(
      {required this.cidr, required this.coipPoolId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        cidr, r'DeleteCoipCidrRequest', 'cidr');
    BuiltValueNullFieldError.checkNotNull(
        coipPoolId, r'DeleteCoipCidrRequest', 'coipPoolId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$DeleteCoipCidrRequest._(
            cidr: BuiltValueNullFieldError.checkNotNull(
                cidr, r'DeleteCoipCidrRequest', 'cidr'),
            coipPoolId: BuiltValueNullFieldError.checkNotNull(
                coipPoolId, r'DeleteCoipCidrRequest', 'coipPoolId'),
