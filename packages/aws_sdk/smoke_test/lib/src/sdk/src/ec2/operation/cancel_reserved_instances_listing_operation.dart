...
class CancelReservedInstancesListingOperation extends _i1.HttpOperation<
    _i2.CancelReservedInstancesListingRequest,
    _i2.CancelReservedInstancesListingRequest,
    _i3.CancelReservedInstancesListingResult,
    _i3.CancelReservedInstancesListingResult> {
  /// Cancels the specified Reserved Instance listing in the Reserved Instance Marketplace.
  ///
  /// For more information, see [Reserved Instance Marketplace](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-market-general.html) in the _Amazon EC2 User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CancelReservedInstancesListingRequest,
          _i3.CancelReservedInstancesListingResult,
          _i3.CancelReservedInstancesListingResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.CancelReservedInstancesListingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CancelReservedInstancesListingResult? output]) => 200;
  @override
  _i3.CancelReservedInstancesListingResult buildOutput(
    _i3.CancelReservedInstancesListingResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CancelReservedInstancesListingResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CancelReservedInstancesListingResult> run(
    _i2.CancelReservedInstancesListingRequest input, {
