...
class _$Monitoring extends Monitoring {
  @override
  final _i2.MonitoringState? state;
...
class MonitoringBuilder implements Builder<Monitoring, MonitoringBuilder> {
  ...
  _i2.MonitoringState? _state;
  _i2.MonitoringState? get state => _$this._state;
  set state(_i2.MonitoringState? state) => _$this._state = state;

  MonitoringBuilder() {
    Monitoring._init(this);
  }
