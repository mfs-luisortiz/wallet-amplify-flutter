...
class _$DeleteNetworkInsightsAnalysisRequest
  ...
  _$DeleteNetworkInsightsAnalysisRequest._(
      {required this.dryRun, required this.networkInsightsAnalysisId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeleteNetworkInsightsAnalysisRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(networkInsightsAnalysisId,
        r'DeleteNetworkInsightsAnalysisRequest', 'networkInsightsAnalysisId');
  }
    ...
    final _$result = _$v ??
        new _$DeleteNetworkInsightsAnalysisRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'DeleteNetworkInsightsAnalysisRequest', 'dryRun'),
            networkInsightsAnalysisId: BuiltValueNullFieldError.checkNotNull(
                networkInsightsAnalysisId,
                r'DeleteNetworkInsightsAnalysisRequest',
                'networkInsightsAnalysisId'));
    replace(_$result);
    return _$result;
  }
