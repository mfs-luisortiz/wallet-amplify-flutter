...
class CreateVpcEndpointServiceConfigurationOperation extends _i1.HttpOperation<
    _i2.CreateVpcEndpointServiceConfigurationRequest,
    _i2.CreateVpcEndpointServiceConfigurationRequest,
    _i3.CreateVpcEndpointServiceConfigurationResult,
    _i3.CreateVpcEndpointServiceConfigurationResult> {
  /// Creates a VPC endpoint service to which service consumers (Amazon Web Services accounts, IAM users, and IAM roles) can connect.
  ///
  /// Before you create an endpoint service, you must create one of the following for your service:
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateVpcEndpointServiceConfigurationRequest,
          _i3.CreateVpcEndpointServiceConfigurationResult,
          _i3.CreateVpcEndpointServiceConfigurationResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.CreateVpcEndpointServiceConfigurationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateVpcEndpointServiceConfigurationResult? output]) =>
      200;
  @override
  _i3.CreateVpcEndpointServiceConfigurationResult buildOutput(
    _i3.CreateVpcEndpointServiceConfigurationResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateVpcEndpointServiceConfigurationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateVpcEndpointServiceConfigurationResult> run(
    _i2.CreateVpcEndpointServiceConfigurationRequest input, {
