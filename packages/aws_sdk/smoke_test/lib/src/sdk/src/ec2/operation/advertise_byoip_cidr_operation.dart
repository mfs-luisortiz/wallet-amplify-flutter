...
class AdvertiseByoipCidrOperation extends _i1.HttpOperation<
    _i2.AdvertiseByoipCidrRequest,
    _i2.AdvertiseByoipCidrRequest,
    _i3.AdvertiseByoipCidrResult,
    _i3.AdvertiseByoipCidrResult> {
  /// Advertises an IPv4 or IPv6 address range that is provisioned for use with your Amazon Web Services resources through bring your own IP addresses (BYOIP).
  ///
  /// You can perform this operation at most once every 10 seconds, even if you specify different address ranges each time.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.AdvertiseByoipCidrRequest,
          _i3.AdvertiseByoipCidrResult,
          _i3.AdvertiseByoipCidrResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.AdvertiseByoipCidrRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.AdvertiseByoipCidrResult? output]) => 200;
  @override
  _i3.AdvertiseByoipCidrResult buildOutput(
    _i3.AdvertiseByoipCidrResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.AdvertiseByoipCidrResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.AdvertiseByoipCidrResult> run(
    _i2.AdvertiseByoipCidrRequest input, {
