...
class _$RunScheduledInstancesRequest extends RunScheduledInstancesRequest {
  ...
  @override
  final _i3.ScheduledInstancesLaunchSpecification launchSpecification;
  @override
  ...
  _$RunScheduledInstancesRequest._(
      ...
      required this.scheduledInstanceId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'RunScheduledInstancesRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        instanceCount, r'RunScheduledInstancesRequest', 'instanceCount');
    BuiltValueNullFieldError.checkNotNull(launchSpecification,
        r'RunScheduledInstancesRequest', 'launchSpecification');
    BuiltValueNullFieldError.checkNotNull(scheduledInstanceId,
        r'RunScheduledInstancesRequest', 'scheduledInstanceId');
  }
...
class RunScheduledInstancesRequestBuilder
  ...
  _i3.ScheduledInstancesLaunchSpecificationBuilder? _launchSpecification;
  _i3.ScheduledInstancesLaunchSpecificationBuilder get launchSpecification =>
      _$this._launchSpecification ??=
          new _i3.ScheduledInstancesLaunchSpecificationBuilder();
  set launchSpecification(
          _i3.ScheduledInstancesLaunchSpecificationBuilder?
              launchSpecification) =>
    ...
    try {
      _$result = _$v ??
          new _$RunScheduledInstancesRequest._(
              ...
              scheduledInstanceId: BuiltValueNullFieldError.checkNotNull(
                  scheduledInstanceId,
                  r'RunScheduledInstancesRequest',
                  'scheduledInstanceId'));
    } catch (_) {
