...
class _$CancelExportTaskRequest extends CancelExportTaskRequest {
  ...
  _$CancelExportTaskRequest._({required this.exportTaskId}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        exportTaskId, r'CancelExportTaskRequest', 'exportTaskId');
  }
  ...
  _$CancelExportTaskRequest _build() {
    final _$result = _$v ??
        new _$CancelExportTaskRequest._(
            exportTaskId: BuiltValueNullFieldError.checkNotNull(
                exportTaskId, r'CancelExportTaskRequest', 'exportTaskId'));
    replace(_$result);
    return _$result;
  }
