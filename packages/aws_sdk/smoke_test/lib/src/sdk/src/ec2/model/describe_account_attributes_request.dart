...
abstract class DescribeAccountAttributesRequest
  ...
  factory DescribeAccountAttributesRequest({
    List<_i3.AccountAttributeName>? attributeNames,
    bool? dryRun,
  }) {
    dryRun ??= false;
    return _$DescribeAccountAttributesRequest._(
      attributeNames:
          attributeNames == null ? null : _i4.BuiltList(attributeNames),
      dryRun: dryRun,
    );
  }
  ...
  static const List<_i1.SmithySerializer> serializers = [
    DescribeAccountAttributesRequestEc2QuerySerializer()
  ];
  ...
  _i4.BuiltList<_i3.AccountAttributeName>? get attributeNames;
