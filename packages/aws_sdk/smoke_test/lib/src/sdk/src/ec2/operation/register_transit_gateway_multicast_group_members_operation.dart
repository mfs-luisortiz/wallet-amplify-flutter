...
class RegisterTransitGatewayMulticastGroupMembersOperation
    extends _i1.HttpOperation<
        _i2.RegisterTransitGatewayMulticastGroupMembersRequest,
        _i2.RegisterTransitGatewayMulticastGroupMembersRequest,
        _i3.RegisterTransitGatewayMulticastGroupMembersResult,
        _i3.RegisterTransitGatewayMulticastGroupMembersResult> {
  /// Registers members (network interfaces) with the transit gateway multicast group. A member is a network interface associated with a supported EC2 instance that receives multicast traffic. For information about supported instances, see [Multicast Consideration](https://docs.aws.amazon.com/vpc/latest/tgw/transit-gateway-limits.html#multicast-limits) in _Amazon VPC Transit Gateways_.
  ///
  /// After you add the members, use [SearchTransitGatewayMulticastGroups](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SearchTransitGatewayMulticastGroups.html) to verify that the members were added to the transit gateway multicast group.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.RegisterTransitGatewayMulticastGroupMembersRequest,
          _i3.RegisterTransitGatewayMulticastGroupMembersResult,
          _i3.RegisterTransitGatewayMulticastGroupMembersResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.RegisterTransitGatewayMulticastGroupMembersRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode(
          [_i3.RegisterTransitGatewayMulticastGroupMembersResult? output]) =>
      200;
  @override
  _i3.RegisterTransitGatewayMulticastGroupMembersResult buildOutput(
    _i3.RegisterTransitGatewayMulticastGroupMembersResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.RegisterTransitGatewayMulticastGroupMembersResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.RegisterTransitGatewayMulticastGroupMembersResult>
      run(
    _i2.RegisterTransitGatewayMulticastGroupMembersRequest input, {
