...
class _$ModifyInstanceEventStartTimeRequest
  ...
  _$ModifyInstanceEventStartTimeRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        instanceId, r'ModifyInstanceEventStartTimeRequest', 'instanceId');
    BuiltValueNullFieldError.checkNotNull(instanceEventId,
        r'ModifyInstanceEventStartTimeRequest', 'instanceEventId');
    BuiltValueNullFieldError.checkNotNull(
        notBefore, r'ModifyInstanceEventStartTimeRequest', 'notBefore');
  }
    ...
    final _$result = _$v ??
        new _$ModifyInstanceEventStartTimeRequest._(
            ...
            instanceId: BuiltValueNullFieldError.checkNotNull(instanceId,
                r'ModifyInstanceEventStartTimeRequest', 'instanceId'),
            instanceEventId: BuiltValueNullFieldError.checkNotNull(
                instanceEventId,
                r'ModifyInstanceEventStartTimeRequest',
                'instanceEventId'),
            notBefore: BuiltValueNullFieldError.checkNotNull(notBefore,
                r'ModifyInstanceEventStartTimeRequest', 'notBefore'));
    replace(_$result);
    return _$result;
  }
}
