...
class _$DeleteManagedPrefixListRequest extends DeleteManagedPrefixListRequest {
  ...
  _$DeleteManagedPrefixListRequest._(
      {required this.dryRun, required this.prefixListId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeleteManagedPrefixListRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        prefixListId, r'DeleteManagedPrefixListRequest', 'prefixListId');
  }
    ...
    final _$result = _$v ??
        new _$DeleteManagedPrefixListRequest._(
            ...
            prefixListId: BuiltValueNullFieldError.checkNotNull(prefixListId,
                r'DeleteManagedPrefixListRequest', 'prefixListId'));
    replace(_$result);
    return _$result;
  }
}
