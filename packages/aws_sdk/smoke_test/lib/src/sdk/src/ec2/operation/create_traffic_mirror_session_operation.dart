...
class CreateTrafficMirrorSessionOperation extends _i1.HttpOperation<
    _i2.CreateTrafficMirrorSessionRequest,
    _i2.CreateTrafficMirrorSessionRequest,
    _i3.CreateTrafficMirrorSessionResult,
    _i3.CreateTrafficMirrorSessionResult> {
  /// Creates a Traffic Mirror session.
  ///
  /// A Traffic Mirror session actively copies packets from a Traffic Mirror source to a Traffic Mirror target. Create a filter, and then assign it to the session to define a subset of the traffic to mirror, for example all TCP traffic.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateTrafficMirrorSessionRequest,
          _i3.CreateTrafficMirrorSessionResult,
          _i3.CreateTrafficMirrorSessionResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateTrafficMirrorSessionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateTrafficMirrorSessionResult? output]) => 200;
  @override
  _i3.CreateTrafficMirrorSessionResult buildOutput(
    _i3.CreateTrafficMirrorSessionResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateTrafficMirrorSessionResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateTrafficMirrorSessionResult> run(
    _i2.CreateTrafficMirrorSessionRequest input, {
