...
class _$DeprovisionIpamPoolCidrResult extends DeprovisionIpamPoolCidrResult {
  @override
  final _i2.IpamPoolCidr? ipamPoolCidr;
...
class DeprovisionIpamPoolCidrResultBuilder
  ...
  _i2.IpamPoolCidrBuilder? _ipamPoolCidr;
  _i2.IpamPoolCidrBuilder get ipamPoolCidr =>
      _$this._ipamPoolCidr ??= new _i2.IpamPoolCidrBuilder();
  set ipamPoolCidr(_i2.IpamPoolCidrBuilder? ipamPoolCidr) =>
      _$this._ipamPoolCidr = ipamPoolCidr;

  DeprovisionIpamPoolCidrResultBuilder() {
    DeprovisionIpamPoolCidrResult._init(this);
  }
