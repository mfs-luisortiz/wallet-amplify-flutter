...
class ExportTransitGatewayRoutesOperation extends _i1.HttpOperation<
    _i2.ExportTransitGatewayRoutesRequest,
    _i2.ExportTransitGatewayRoutesRequest,
    _i3.ExportTransitGatewayRoutesResult,
    _i3.ExportTransitGatewayRoutesResult> {
  /// Exports routes from the specified transit gateway route table to the specified S3 bucket. By default, all routes are exported. Alternatively, you can filter by CIDR range.
  ///
  /// The routes are saved to the specified bucket in a JSON file. For more information, see [Export Route Tables to Amazon S3](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-route-tables.html#tgw-export-route-tables) in _Transit Gateways_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ExportTransitGatewayRoutesRequest,
          _i3.ExportTransitGatewayRoutesResult,
          _i3.ExportTransitGatewayRoutesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ExportTransitGatewayRoutesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ExportTransitGatewayRoutesResult? output]) => 200;
  @override
  _i3.ExportTransitGatewayRoutesResult buildOutput(
    _i3.ExportTransitGatewayRoutesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ExportTransitGatewayRoutesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ExportTransitGatewayRoutesResult> run(
    _i2.ExportTransitGatewayRoutesRequest input, {
