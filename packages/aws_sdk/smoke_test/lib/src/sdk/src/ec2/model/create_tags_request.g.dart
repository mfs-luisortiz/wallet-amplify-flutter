...
class _$CreateTagsRequest extends CreateTagsRequest {
  ...
  final bool dryRun;
  @override
  final _i4.BuiltList<String> resources;
  @override
  ...
  _$CreateTagsRequest._(
      {required this.dryRun, required this.resources, required this.tags})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'CreateTagsRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        resources, r'CreateTagsRequest', 'resources');
    BuiltValueNullFieldError.checkNotNull(tags, r'CreateTagsRequest', 'tags');
  }
...
class CreateTagsRequestBuilder
  ...
  _i4.ListBuilder<String>? _resources;
  _i4.ListBuilder<String> get resources =>
      _$this._resources ??= new _i4.ListBuilder<String>();
  set resources(_i4.ListBuilder<String>? resources) =>
