...
class DescribeAddressesOperation extends _i1.HttpOperation<
    _i2.DescribeAddressesRequest,
    _i2.DescribeAddressesRequest,
    _i3.DescribeAddressesResult,
    _i3.DescribeAddressesResult> {
  /// Describes the specified Elastic IP addresses or all of your Elastic IP addresses.
  ///
  /// An Elastic IP address is for use in either the EC2-Classic platform or in a VPC. For more information, see [Elastic IP Addresses](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html) in the _Amazon Elastic Compute Cloud User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeAddressesRequest,
          _i3.DescribeAddressesResult,
          _i3.DescribeAddressesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeAddressesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeAddressesResult? output]) => 200;
  @override
  _i3.DescribeAddressesResult buildOutput(
    _i3.DescribeAddressesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeAddressesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeAddressesResult> run(
    _i2.DescribeAddressesRequest input, {
