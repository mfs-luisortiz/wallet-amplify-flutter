...
class AttachVpnGatewayOperation extends _i1.HttpOperation<
    _i2.AttachVpnGatewayRequest,
    _i2.AttachVpnGatewayRequest,
    _i3.AttachVpnGatewayResult,
    _i3.AttachVpnGatewayResult> {
  /// Attaches a virtual private gateway to a VPC. You can attach one virtual private gateway to one VPC at a time.
  ///
  /// For more information, see [Amazon Web Services Site-to-Site VPN](https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html) in the _Amazon Web Services Site-to-Site VPN User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.AttachVpnGatewayRequest, _i2.AttachVpnGatewayRequest,
          _i3.AttachVpnGatewayResult, _i3.AttachVpnGatewayResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.AttachVpnGatewayRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.AttachVpnGatewayResult? output]) => 200;
  @override
  _i3.AttachVpnGatewayResult buildOutput(
    _i3.AttachVpnGatewayResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.AttachVpnGatewayResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.AttachVpnGatewayResult> run(
    _i2.AttachVpnGatewayRequest input, {
