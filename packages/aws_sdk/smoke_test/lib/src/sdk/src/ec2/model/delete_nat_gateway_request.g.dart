...
class _$DeleteNatGatewayRequest extends DeleteNatGatewayRequest {
  ...
  _$DeleteNatGatewayRequest._(
      {required this.dryRun, required this.natGatewayId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeleteNatGatewayRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        natGatewayId, r'DeleteNatGatewayRequest', 'natGatewayId');
  }
    ...
    final _$result = _$v ??
        new _$DeleteNatGatewayRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'DeleteNatGatewayRequest', 'dryRun'),
            natGatewayId: BuiltValueNullFieldError.checkNotNull(
                natGatewayId, r'DeleteNatGatewayRequest', 'natGatewayId'));
    replace(_$result);
    return _$result;
  }
