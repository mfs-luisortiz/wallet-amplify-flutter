...
abstract class DescribeNetworkInterfaceAttributeRequest
  ...
  factory DescribeNetworkInterfaceAttributeRequest({
    _i3.NetworkInterfaceAttribute? attribute,
    bool? dryRun,
  ...
  _i3.NetworkInterfaceAttribute? get attribute;
      ...
      switch (key) {
        case 'attribute':
          result.attribute = (serializers.deserialize(
            value,
            specifiedType: const FullType(_i3.NetworkInterfaceAttribute),
          ) as _i3.NetworkInterfaceAttribute);
        case 'dryRun':
    ...
    if (attribute != null) {
      result$
        ...
        ..add(serializers.serialize(
          attribute,
          specifiedType: const FullType.nullable(_i3.NetworkInterfaceAttribute),
        ));
    }
    result$
