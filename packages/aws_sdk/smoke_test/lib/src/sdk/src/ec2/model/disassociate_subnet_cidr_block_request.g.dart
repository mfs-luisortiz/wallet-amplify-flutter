...
class _$DisassociateSubnetCidrBlockRequest
  ...
  _$DisassociateSubnetCidrBlockRequest._({required this.associationId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        associationId, r'DisassociateSubnetCidrBlockRequest', 'associationId');
  }
...
class DisassociateSubnetCidrBlockRequestBuilder
  ...
  DisassociateSubnetCidrBlockRequestBuilder() {
    DisassociateSubnetCidrBlockRequest._init(this);
  }
    ...
    final _$result = _$v ??
        new _$DisassociateSubnetCidrBlockRequest._(
            associationId: BuiltValueNullFieldError.checkNotNull(associationId,
                r'DisassociateSubnetCidrBlockRequest', 'associationId'));
    replace(_$result);
    return _$result;
  }
}
