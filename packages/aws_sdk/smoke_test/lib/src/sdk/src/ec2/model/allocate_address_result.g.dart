...
class AllocateAddressResultBuilder
  ...
  _i2.DomainType? _domain;
  _i2.DomainType? get domain => _$this._domain;
  set domain(_i2.DomainType? domain) => _$this._domain = domain;
  ...
  AllocateAddressResultBuilder() {
    AllocateAddressResult._init(this);
  }
