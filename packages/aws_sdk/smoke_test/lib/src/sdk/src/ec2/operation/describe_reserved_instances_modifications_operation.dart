...
class DescribeReservedInstancesModificationsOperation
    extends _i1.PaginatedHttpOperation<
        _i2.DescribeReservedInstancesModificationsRequest,
        _i2.DescribeReservedInstancesModificationsRequest,
        _i3.DescribeReservedInstancesModificationsResult,
        _i3.DescribeReservedInstancesModificationsResult,
        String,
        void,
        _i4.BuiltList<_i5.ReservedInstancesModification>> {
  /// Describes the modifications made to your Reserved Instances. If no parameter is specified, information about all your Reserved Instances modification requests is returned. If a modification ID is specified, only information about the specific modification is returned.
  ///
  /// For more information, see [Modifying Reserved Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-modifying.html) in the _Amazon EC2 User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeReservedInstancesModificationsRequest,
          _i3.DescribeReservedInstancesModificationsResult,
          _i3.DescribeReservedInstancesModificationsResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.DescribeReservedInstancesModificationsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeReservedInstancesModificationsResult? output]) =>
      200;
  @override
  _i3.DescribeReservedInstancesModificationsResult buildOutput(
    _i3.DescribeReservedInstancesModificationsResult payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeReservedInstancesModificationsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeReservedInstancesModificationsResult> run(
    _i2.DescribeReservedInstancesModificationsRequest input, {
  ...
  @override
  String? getToken(_i3.DescribeReservedInstancesModificationsResult output) =>
      output.nextToken;
  @override
  _i4.BuiltList<_i5.ReservedInstancesModification> getItems(
          _i3.DescribeReservedInstancesModificationsResult output) =>
      output.reservedInstancesModifications ?? _i4.BuiltList();
  @override
  _i2.DescribeReservedInstancesModificationsRequest rebuildInput(
    _i2.DescribeReservedInstancesModificationsRequest input,
    String token,
    void pageSize,
  ) =>
