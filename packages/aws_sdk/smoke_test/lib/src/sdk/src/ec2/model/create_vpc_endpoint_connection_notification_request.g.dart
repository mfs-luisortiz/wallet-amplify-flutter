...
class _$CreateVpcEndpointConnectionNotificationRequest
  ...
  _$CreateVpcEndpointConnectionNotificationRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        ...
        'connectionNotificationArn');
    BuiltValueNullFieldError.checkNotNull(connectionEvents,
        r'CreateVpcEndpointConnectionNotificationRequest', 'connectionEvents');
  }
    ...
    try {
      _$result = _$v ??
          new _$CreateVpcEndpointConnectionNotificationRequest._(
              ...
              connectionNotificationArn: BuiltValueNullFieldError.checkNotNull(
                  connectionNotificationArn,
                  r'CreateVpcEndpointConnectionNotificationRequest',
                  'connectionNotificationArn'),
              connectionEvents: connectionEvents.build(),
              clientToken: clientToken);
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'connectionEvents';
        connectionEvents.build();
      } catch (e) {
