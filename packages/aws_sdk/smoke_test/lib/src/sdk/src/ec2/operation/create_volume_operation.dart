...
import 'package:smoke_test/src/sdk/src/ec2/model/create_volume_request.dart'
    as _i2;
import 'package:smoke_test/src/sdk/src/ec2/model/volume.dart' as _i3;
...
class CreateVolumeOperation extends _i1.HttpOperation<_i2.CreateVolumeRequest,
    _i2.CreateVolumeRequest, _i3.Volume, _i3.Volume> {
  /// Creates an EBS volume that can be attached to an instance in the same Availability Zone.
  ///
  /// You can create a new empty volume or restore a volume from an EBS snapshot. Any Amazon Web Services Marketplace product codes from the snapshot are propagated to the volume.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateVolumeRequest, _i2.CreateVolumeRequest,
          _i3.Volume, _i3.Volume>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateVolumeRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.Volume? output]) => 200;
  @override
  _i3.Volume buildOutput(
    _i3.Volume payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.Volume.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.Volume> run(
    _i2.CreateVolumeRequest input, {
