...
class DescribeAvailabilityZonesOperation extends _i1.HttpOperation<
    _i2.DescribeAvailabilityZonesRequest,
    _i2.DescribeAvailabilityZonesRequest,
    _i3.DescribeAvailabilityZonesResult,
    _i3.DescribeAvailabilityZonesResult> {
  /// Describes the Availability Zones, Local Zones, and Wavelength Zones that are available to you. If there is an event impacting a zone, you can use this request to view the state and any provided messages for that zone.
  ///
  /// For more information about Availability Zones, Local Zones, and Wavelength Zones, see [Regions and zones](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html) in the _Amazon Elastic Compute Cloud User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeAvailabilityZonesRequest,
          _i3.DescribeAvailabilityZonesResult,
          _i3.DescribeAvailabilityZonesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeAvailabilityZonesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeAvailabilityZonesResult? output]) => 200;
  @override
  _i3.DescribeAvailabilityZonesResult buildOutput(
    _i3.DescribeAvailabilityZonesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeAvailabilityZonesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeAvailabilityZonesResult> run(
    _i2.DescribeAvailabilityZonesRequest input, {
