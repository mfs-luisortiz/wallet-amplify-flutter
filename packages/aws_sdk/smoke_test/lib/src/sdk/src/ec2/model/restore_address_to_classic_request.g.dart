...
class _$RestoreAddressToClassicRequest extends RestoreAddressToClassicRequest {
  ...
  _$RestoreAddressToClassicRequest._(
      {required this.dryRun, required this.publicIp})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'RestoreAddressToClassicRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        publicIp, r'RestoreAddressToClassicRequest', 'publicIp');
  }
    ...
    final _$result = _$v ??
        new _$RestoreAddressToClassicRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'RestoreAddressToClassicRequest', 'dryRun'),
            publicIp: BuiltValueNullFieldError.checkNotNull(
                publicIp, r'RestoreAddressToClassicRequest', 'publicIp'));
    replace(_$result);
    return _$result;
  }
