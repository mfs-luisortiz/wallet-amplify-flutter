...
class _$ModifyAvailabilityZoneGroupRequest
  ...
  @override
  final _i3.ModifyAvailabilityZoneOptInStatus optInStatus;
  @override
  final bool dryRun;
  ...
  _$ModifyAvailabilityZoneGroupRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        groupName, r'ModifyAvailabilityZoneGroupRequest', 'groupName');
    BuiltValueNullFieldError.checkNotNull(
        optInStatus, r'ModifyAvailabilityZoneGroupRequest', 'optInStatus');
    BuiltValueNullFieldError.checkNotNull(
...
class ModifyAvailabilityZoneGroupRequestBuilder
  ...
  _i3.ModifyAvailabilityZoneOptInStatus? _optInStatus;
  _i3.ModifyAvailabilityZoneOptInStatus? get optInStatus => _$this._optInStatus;
  set optInStatus(_i3.ModifyAvailabilityZoneOptInStatus? optInStatus) =>
    ...
    final _$result = _$v ??
        new _$ModifyAvailabilityZoneGroupRequest._(
            groupName: BuiltValueNullFieldError.checkNotNull(
                groupName, r'ModifyAvailabilityZoneGroupRequest', 'groupName'),
            optInStatus: BuiltValueNullFieldError.checkNotNull(optInStatus,
                r'ModifyAvailabilityZoneGroupRequest', 'optInStatus'),
