...
class _$HostReservation extends HostReservation {
  ...
  final int count;
  @override
  final _i2.CurrencyCodeValues? currencyCode;
  @override
  final int duration;
  @override
  final DateTime? end;
  @override
  final _i6.BuiltList<String>? hostIdSet;
  @override
  ...
  @override
  final _i3.PaymentOption? paymentOption;
  @override
  final DateTime? start;
  @override
  final _i4.ReservationState? state;
  @override
...
class HostReservationBuilder
  ...
  _i2.CurrencyCodeValues? _currencyCode;
  _i2.CurrencyCodeValues? get currencyCode => _$this._currencyCode;
  set currencyCode(_i2.CurrencyCodeValues? currencyCode) =>
  ...
  _i6.ListBuilder<String>? _hostIdSet;
  _i6.ListBuilder<String> get hostIdSet =>
      _$this._hostIdSet ??= new _i6.ListBuilder<String>();
  set hostIdSet(_i6.ListBuilder<String>? hostIdSet) =>
  ...
  _i3.PaymentOption? _paymentOption;
  _i3.PaymentOption? get paymentOption => _$this._paymentOption;
  set paymentOption(_i3.PaymentOption? paymentOption) =>
  ...
  _i4.ReservationState? _state;
  _i4.ReservationState? get state => _$this._state;
  set state(_i4.ReservationState? state) => _$this._state = state;
