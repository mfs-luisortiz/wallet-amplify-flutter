...
class _$DeleteTransitGatewayConnectPeerRequest
  ...
  _$DeleteTransitGatewayConnectPeerRequest._(
      {required this.transitGatewayConnectPeerId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        transitGatewayConnectPeerId,
        r'DeleteTransitGatewayConnectPeerRequest',
        'transitGatewayConnectPeerId');
    BuiltValueNullFieldError.checkNotNull(
  ...
  _$DeleteTransitGatewayConnectPeerRequest _build() {
    final _$result = _$v ??
        new _$DeleteTransitGatewayConnectPeerRequest._(
            transitGatewayConnectPeerId: BuiltValueNullFieldError.checkNotNull(
                transitGatewayConnectPeerId,
                r'DeleteTransitGatewayConnectPeerRequest',
                'transitGatewayConnectPeerId'),
