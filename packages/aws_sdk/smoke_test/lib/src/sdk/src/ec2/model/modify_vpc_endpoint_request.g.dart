...
class _$ModifyVpcEndpointRequest extends ModifyVpcEndpointRequest {
  ...
  @override
  final _i5.BuiltList<String>? addRouteTableIds;
  @override
  final _i5.BuiltList<String>? removeRouteTableIds;
  @override
  final _i5.BuiltList<String>? addSubnetIds;
  @override
  final _i5.BuiltList<String>? removeSubnetIds;
  @override
  final _i5.BuiltList<String>? addSecurityGroupIds;
  @override
  final _i5.BuiltList<String>? removeSecurityGroupIds;
  @override
  final _i3.IpAddressType? ipAddressType;
  @override
  final _i4.DnsOptionsSpecification? dnsOptions;
  @override
  ...
  _$ModifyVpcEndpointRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        vpcEndpointId, r'ModifyVpcEndpointRequest', 'vpcEndpointId');
    BuiltValueNullFieldError.checkNotNull(
...
class ModifyVpcEndpointRequestBuilder
  ...
  _i5.ListBuilder<String>? _addRouteTableIds;
  _i5.ListBuilder<String> get addRouteTableIds =>
      _$this._addRouteTableIds ??= new _i5.ListBuilder<String>();
  set addRouteTableIds(_i5.ListBuilder<String>? addRouteTableIds) =>
      _$this._addRouteTableIds = addRouteTableIds;

  _i5.ListBuilder<String>? _removeRouteTableIds;
  _i5.ListBuilder<String> get removeRouteTableIds =>
      _$this._removeRouteTableIds ??= new _i5.ListBuilder<String>();
  set removeRouteTableIds(_i5.ListBuilder<String>? removeRouteTableIds) =>
      _$this._removeRouteTableIds = removeRouteTableIds;

  _i5.ListBuilder<String>? _addSubnetIds;
  _i5.ListBuilder<String> get addSubnetIds =>
      _$this._addSubnetIds ??= new _i5.ListBuilder<String>();
  set addSubnetIds(_i5.ListBuilder<String>? addSubnetIds) =>
      _$this._addSubnetIds = addSubnetIds;

  _i5.ListBuilder<String>? _removeSubnetIds;
  _i5.ListBuilder<String> get removeSubnetIds =>
      _$this._removeSubnetIds ??= new _i5.ListBuilder<String>();
  set removeSubnetIds(_i5.ListBuilder<String>? removeSubnetIds) =>
      _$this._removeSubnetIds = removeSubnetIds;

  _i5.ListBuilder<String>? _addSecurityGroupIds;
  _i5.ListBuilder<String> get addSecurityGroupIds =>
      _$this._addSecurityGroupIds ??= new _i5.ListBuilder<String>();
  set addSecurityGroupIds(_i5.ListBuilder<String>? addSecurityGroupIds) =>
      _$this._addSecurityGroupIds = addSecurityGroupIds;

  _i5.ListBuilder<String>? _removeSecurityGroupIds;
  _i5.ListBuilder<String> get removeSecurityGroupIds =>
      _$this._removeSecurityGroupIds ??= new _i5.ListBuilder<String>();
  set removeSecurityGroupIds(_i5.ListBuilder<String>? removeSecurityGroupIds) =>
      _$this._removeSecurityGroupIds = removeSecurityGroupIds;

  _i3.IpAddressType? _ipAddressType;
  _i3.IpAddressType? get ipAddressType => _$this._ipAddressType;
  set ipAddressType(_i3.IpAddressType? ipAddressType) =>
      _$this._ipAddressType = ipAddressType;

  _i4.DnsOptionsSpecificationBuilder? _dnsOptions;
  _i4.DnsOptionsSpecificationBuilder get dnsOptions =>
      _$this._dnsOptions ??= new _i4.DnsOptionsSpecificationBuilder();
  set dnsOptions(_i4.DnsOptionsSpecificationBuilder? dnsOptions) =>
      ...
      _$result = _$v ??
          new _$ModifyVpcEndpointRequest._(
              dryRun: BuiltValueNullFieldError.checkNotNull(
                  dryRun, r'ModifyVpcEndpointRequest', 'dryRun'),
              vpcEndpointId: BuiltValueNullFieldError.checkNotNull(
                  vpcEndpointId, r'ModifyVpcEndpointRequest', 'vpcEndpointId'),
