...
class _$DeprovisionPublicIpv4PoolCidrRequest
  ...
  _$DeprovisionPublicIpv4PoolCidrRequest._(
      {required this.dryRun, required this.poolId, required this.cidr})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeprovisionPublicIpv4PoolCidrRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        poolId, r'DeprovisionPublicIpv4PoolCidrRequest', 'poolId');
    BuiltValueNullFieldError.checkNotNull(
        cidr, r'DeprovisionPublicIpv4PoolCidrRequest', 'cidr');
  }
