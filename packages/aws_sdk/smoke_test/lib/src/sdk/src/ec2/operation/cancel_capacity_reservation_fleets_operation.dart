...
class CancelCapacityReservationFleetsOperation extends _i1.HttpOperation<
    _i2.CancelCapacityReservationFleetsRequest,
    _i2.CancelCapacityReservationFleetsRequest,
    _i3.CancelCapacityReservationFleetsResult,
    _i3.CancelCapacityReservationFleetsResult> {
  /// Cancels one or more Capacity Reservation Fleets. When you cancel a Capacity Reservation Fleet, the following happens:
  ///
  /// *   The Capacity Reservation Fleet's status changes to `cancelled`.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CancelCapacityReservationFleetsRequest,
          _i3.CancelCapacityReservationFleetsResult,
          _i3.CancelCapacityReservationFleetsResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.CancelCapacityReservationFleetsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CancelCapacityReservationFleetsResult? output]) => 200;
  @override
  _i3.CancelCapacityReservationFleetsResult buildOutput(
    _i3.CancelCapacityReservationFleetsResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CancelCapacityReservationFleetsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CancelCapacityReservationFleetsResult> run(
    _i2.CancelCapacityReservationFleetsRequest input, {
