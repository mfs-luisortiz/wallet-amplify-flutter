...
class _$CancelReservedInstancesListingRequest
  ...
  _$CancelReservedInstancesListingRequest._(
      {required this.reservedInstancesListingId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(reservedInstancesListingId,
        r'CancelReservedInstancesListingRequest', 'reservedInstancesListingId');
  }
...
class CancelReservedInstancesListingRequestBuilder
  ...
  CancelReservedInstancesListingRequestBuilder() {
    CancelReservedInstancesListingRequest._init(this);
  }
  ...
  _$CancelReservedInstancesListingRequest _build() {
    final _$result = _$v ??
        new _$CancelReservedInstancesListingRequest._(
            reservedInstancesListingId: BuiltValueNullFieldError.checkNotNull(
                reservedInstancesListingId,
                r'CancelReservedInstancesListingRequest',
                'reservedInstancesListingId'));
    replace(_$result);
    return _$result;
  }
