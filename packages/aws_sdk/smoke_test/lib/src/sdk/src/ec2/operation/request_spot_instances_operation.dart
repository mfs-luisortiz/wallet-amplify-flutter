...
class RequestSpotInstancesOperation extends _i1.HttpOperation<
    _i2.RequestSpotInstancesRequest,
    _i2.RequestSpotInstancesRequest,
    _i3.RequestSpotInstancesResult,
    _i3.RequestSpotInstancesResult> {
  /// Creates a Spot Instance request.
  ///
  /// For more information, see [Spot Instance requests](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-requests.html) in the _Amazon EC2 User Guide for Linux Instances_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.RequestSpotInstancesRequest,
          _i3.RequestSpotInstancesResult,
          _i3.RequestSpotInstancesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.RequestSpotInstancesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.RequestSpotInstancesResult? output]) => 200;
  @override
  _i3.RequestSpotInstancesResult buildOutput(
    _i3.RequestSpotInstancesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.RequestSpotInstancesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.RequestSpotInstancesResult> run(
    _i2.RequestSpotInstancesRequest input, {
