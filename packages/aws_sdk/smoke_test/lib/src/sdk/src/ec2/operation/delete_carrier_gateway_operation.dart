...
class DeleteCarrierGatewayOperation extends _i1.HttpOperation<
    _i2.DeleteCarrierGatewayRequest,
    _i2.DeleteCarrierGatewayRequest,
    _i3.DeleteCarrierGatewayResult,
    _i3.DeleteCarrierGatewayResult> {
  /// Deletes a carrier gateway.
  ///
  /// If you do not delete the route that contains the carrier gateway as the Target, the route is a blackhole route. For information about how to delete a route, see [DeleteRoute](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DeleteRoute.html).
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DeleteCarrierGatewayRequest,
          _i3.DeleteCarrierGatewayResult,
          _i3.DeleteCarrierGatewayResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteCarrierGatewayRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DeleteCarrierGatewayResult? output]) => 200;
  @override
  _i3.DeleteCarrierGatewayResult buildOutput(
    _i3.DeleteCarrierGatewayResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DeleteCarrierGatewayResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DeleteCarrierGatewayResult> run(
    _i2.DeleteCarrierGatewayRequest input, {
