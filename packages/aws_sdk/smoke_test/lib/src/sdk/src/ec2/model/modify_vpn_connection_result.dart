...
abstract class ModifyVpnConnectionResult
  ...
  factory ModifyVpnConnectionResult({_i2.VpnConnection? vpnConnection}) {
  ...
  static const List<_i3.SmithySerializer> serializers = [
    ModifyVpnConnectionResultEc2QuerySerializer()
  ];

  @BuiltValueHook(initializeBuilder: true)
  static void _init(ModifyVpnConnectionResultBuilder b) {}
...
class ModifyVpnConnectionResultEc2QuerySerializer
    extends _i3.StructuredSmithySerializer<ModifyVpnConnectionResult> {
