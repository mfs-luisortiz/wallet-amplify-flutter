...
class _$PurchaseRequest extends PurchaseRequest {
  ...
  _$PurchaseRequest._(
      {required this.instanceCount, required this.purchaseToken})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        instanceCount, r'PurchaseRequest', 'instanceCount');
    BuiltValueNullFieldError.checkNotNull(
        purchaseToken, r'PurchaseRequest', 'purchaseToken');
  }
    ...
    final _$result = _$v ??
        new _$PurchaseRequest._(
            instanceCount: BuiltValueNullFieldError.checkNotNull(
                instanceCount, r'PurchaseRequest', 'instanceCount'),
            purchaseToken: BuiltValueNullFieldError.checkNotNull(
                purchaseToken, r'PurchaseRequest', 'purchaseToken'));
    replace(_$result);
    return _$result;
  }
