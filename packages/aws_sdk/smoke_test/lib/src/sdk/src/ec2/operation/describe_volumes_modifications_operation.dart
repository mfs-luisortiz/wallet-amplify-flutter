...
class DescribeVolumesModificationsOperation extends _i1.PaginatedHttpOperation<
    _i2.DescribeVolumesModificationsRequest,
    _i2.DescribeVolumesModificationsRequest,
    _i3.DescribeVolumesModificationsResult,
    _i3.DescribeVolumesModificationsResult,
    String,
    int,
    _i4.BuiltList<_i5.VolumeModification>> {
  /// Describes the most recent volume modification request for the specified EBS volumes.
  ///
  /// If a volume has never been modified, some information in the output will be null. If a volume has been modified more than once, the output includes only the most recent modification request.
  ///
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeVolumesModificationsRequest,
          _i3.DescribeVolumesModificationsResult,
          _i3.DescribeVolumesModificationsResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeVolumesModificationsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeVolumesModificationsResult? output]) => 200;
  @override
  _i3.DescribeVolumesModificationsResult buildOutput(
    _i3.DescribeVolumesModificationsResult payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeVolumesModificationsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeVolumesModificationsResult> run(
    _i2.DescribeVolumesModificationsRequest input, {
  ...
  @override
  String? getToken(_i3.DescribeVolumesModificationsResult output) =>
      output.nextToken;
  @override
  _i4.BuiltList<_i5.VolumeModification> getItems(
          _i3.DescribeVolumesModificationsResult output) =>
      output.volumesModifications ?? _i4.BuiltList();
  @override
  _i2.DescribeVolumesModificationsRequest rebuildInput(
    _i2.DescribeVolumesModificationsRequest input,
    String token,
    int? pageSize,
  ) =>
