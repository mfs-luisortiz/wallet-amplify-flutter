...
class RegisterTransitGatewayMulticastGroupSourcesOperation
    extends _i1.HttpOperation<
        _i2.RegisterTransitGatewayMulticastGroupSourcesRequest,
        _i2.RegisterTransitGatewayMulticastGroupSourcesRequest,
        _i3.RegisterTransitGatewayMulticastGroupSourcesResult,
        _i3.RegisterTransitGatewayMulticastGroupSourcesResult> {
  /// Registers sources (network interfaces) with the specified transit gateway multicast group.
  ///
  /// A multicast source is a network interface attached to a supported instance that sends multicast traffic. For information about supported instances, see [Multicast Considerations](https://docs.aws.amazon.com/vpc/latest/tgw/transit-gateway-limits.html#multicast-limits) in _Amazon VPC Transit Gateways_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.RegisterTransitGatewayMulticastGroupSourcesRequest,
          _i3.RegisterTransitGatewayMulticastGroupSourcesResult,
          _i3.RegisterTransitGatewayMulticastGroupSourcesResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.RegisterTransitGatewayMulticastGroupSourcesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode(
          [_i3.RegisterTransitGatewayMulticastGroupSourcesResult? output]) =>
      200;
  @override
  _i3.RegisterTransitGatewayMulticastGroupSourcesResult buildOutput(
    _i3.RegisterTransitGatewayMulticastGroupSourcesResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.RegisterTransitGatewayMulticastGroupSourcesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.RegisterTransitGatewayMulticastGroupSourcesResult>
      run(
    _i2.RegisterTransitGatewayMulticastGroupSourcesRequest input, {
