...
abstract class DescribeAvailabilityZonesRequest
  ...
  factory DescribeAvailabilityZonesRequest({
    ...
    return _$DescribeAvailabilityZonesRequest._(
      ...
      zoneNames: zoneNames == null ? null : _i4.BuiltList(zoneNames),
      zoneIds: zoneIds == null ? null : _i4.BuiltList(zoneIds),
  ...
  static const List<_i1.SmithySerializer> serializers = [
    DescribeAvailabilityZonesRequestEc2QuerySerializer()
  ];

  @BuiltValueHook(initializeBuilder: true)
  static void _init(DescribeAvailabilityZonesRequestBuilder b) {
    b.allAvailabilityZones = false;
    b.dryRun = false;
  }
  ...
  _i4.BuiltList<String>? get zoneNames;

  /// The IDs of the Availability Zones, Local Zones, and Wavelength Zones.
  _i4.BuiltList<String>? get zoneIds;
