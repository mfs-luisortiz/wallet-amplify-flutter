...
class _$DeleteCarrierGatewayRequest extends DeleteCarrierGatewayRequest {
  ...
  _$DeleteCarrierGatewayRequest._(
      {required this.carrierGatewayId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        carrierGatewayId, r'DeleteCarrierGatewayRequest', 'carrierGatewayId');
    BuiltValueNullFieldError.checkNotNull(
  ...
  _$DeleteCarrierGatewayRequest _build() {
    final _$result = _$v ??
        new _$DeleteCarrierGatewayRequest._(
            carrierGatewayId: BuiltValueNullFieldError.checkNotNull(
                carrierGatewayId,
                r'DeleteCarrierGatewayRequest',
                'carrierGatewayId'),
