...
class _$DescribeIdentityIdFormatRequest
  ...
  _$DescribeIdentityIdFormatRequest._(
      {required this.principalArn, this.resource})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        principalArn, r'DescribeIdentityIdFormatRequest', 'principalArn');
  }
...
class DescribeIdentityIdFormatRequestBuilder
  ...
  DescribeIdentityIdFormatRequestBuilder() {
    DescribeIdentityIdFormatRequest._init(this);
  }
  ...
  _$DescribeIdentityIdFormatRequest _build() {
    final _$result = _$v ??
        new _$DescribeIdentityIdFormatRequest._(
            principalArn: BuiltValueNullFieldError.checkNotNull(principalArn,
                r'DescribeIdentityIdFormatRequest', 'principalArn'),
            resource: resource);
    replace(_$result);
    return _$result;
  }
