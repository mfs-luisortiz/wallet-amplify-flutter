...
class _$DisassociateRouteTableRequest extends DisassociateRouteTableRequest {
  ...
  _$DisassociateRouteTableRequest._(
      {required this.associationId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        associationId, r'DisassociateRouteTableRequest', 'associationId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$DisassociateRouteTableRequest._(
            associationId: BuiltValueNullFieldError.checkNotNull(associationId,
                r'DisassociateRouteTableRequest', 'associationId'),
