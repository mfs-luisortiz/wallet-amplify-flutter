...
class _$UnassignIpv6AddressesRequest extends UnassignIpv6AddressesRequest {
  ...
  _$UnassignIpv6AddressesRequest._(
      {this.ipv6Addresses, this.ipv6Prefixes, required this.networkInterfaceId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(networkInterfaceId,
        r'UnassignIpv6AddressesRequest', 'networkInterfaceId');
  }
...
class UnassignIpv6AddressesRequestBuilder
  ...
  UnassignIpv6AddressesRequestBuilder() {
    UnassignIpv6AddressesRequest._init(this);
  }
      ...
      _$result = _$v ??
          new _$UnassignIpv6AddressesRequest._(
              ...
              networkInterfaceId: BuiltValueNullFieldError.checkNotNull(
                  networkInterfaceId,
                  r'UnassignIpv6AddressesRequest',
                  'networkInterfaceId'));
    } catch (_) {
