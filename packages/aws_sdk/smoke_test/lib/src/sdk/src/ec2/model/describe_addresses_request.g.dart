...
class _$DescribeAddressesRequest extends DescribeAddressesRequest {
  ...
  @override
  final _i4.BuiltList<String>? publicIps;
  @override
  final _i4.BuiltList<String>? allocationIds;
  @override
  final bool dryRun;
...
class DescribeAddressesRequestBuilder
  ...
  _i4.ListBuilder<String>? _publicIps;
  _i4.ListBuilder<String> get publicIps =>
      _$this._publicIps ??= new _i4.ListBuilder<String>();
  set publicIps(_i4.ListBuilder<String>? publicIps) =>
      _$this._publicIps = publicIps;

  _i4.ListBuilder<String>? _allocationIds;
  _i4.ListBuilder<String> get allocationIds =>
      _$this._allocationIds ??= new _i4.ListBuilder<String>();
  set allocationIds(_i4.ListBuilder<String>? allocationIds) =>
