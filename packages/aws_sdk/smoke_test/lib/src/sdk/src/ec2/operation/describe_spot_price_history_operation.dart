...
import 'package:smoke_test/src/sdk/src/ec2/model/describe_spot_price_history_result.dart'
    as _i3;
import 'package:smoke_test/src/sdk/src/ec2/model/spot_price.dart' as _i5;
...
class DescribeSpotPriceHistoryOperation extends _i1.PaginatedHttpOperation<
    _i2.DescribeSpotPriceHistoryRequest,
    _i2.DescribeSpotPriceHistoryRequest,
    _i3.DescribeSpotPriceHistoryResult,
    _i3.DescribeSpotPriceHistoryResult,
    String,
    int,
    _i4.BuiltList<_i5.SpotPrice>> {
  /// Describes the Spot price history. For more information, see [Spot Instance pricing history](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-spot-instances-history.html) in the _Amazon EC2 User Guide for Linux Instances_.
  ///
  /// When you specify a start and end time, the operation returns the prices of the instance types within that time range. It also returns the last price change before the start time, which is the effective price as of the start time.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeSpotPriceHistoryRequest,
          _i3.DescribeSpotPriceHistoryResult,
          _i3.DescribeSpotPriceHistoryResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeSpotPriceHistoryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeSpotPriceHistoryResult? output]) => 200;
  @override
  _i3.DescribeSpotPriceHistoryResult buildOutput(
    _i3.DescribeSpotPriceHistoryResult payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeSpotPriceHistoryResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeSpotPriceHistoryResult> run(
    _i2.DescribeSpotPriceHistoryRequest input, {
  ...
  @override
  String? getToken(_i3.DescribeSpotPriceHistoryResult output) =>
      output.nextToken;
  @override
  _i4.BuiltList<_i5.SpotPrice> getItems(
          _i3.DescribeSpotPriceHistoryResult output) =>
      output.spotPriceHistory ?? _i4.BuiltList();
  @override
  _i2.DescribeSpotPriceHistoryRequest rebuildInput(
    _i2.DescribeSpotPriceHistoryRequest input,
    String token,
    int? pageSize,
  ) =>
