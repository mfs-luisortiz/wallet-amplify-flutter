...
class _$DeleteEgressOnlyInternetGatewayRequest
  ...
  _$DeleteEgressOnlyInternetGatewayRequest._(
      {required this.dryRun, required this.egressOnlyInternetGatewayId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'DeleteEgressOnlyInternetGatewayRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        egressOnlyInternetGatewayId,
        r'DeleteEgressOnlyInternetGatewayRequest',
        'egressOnlyInternetGatewayId');
  }
    ...
    final _$result = _$v ??
        new _$DeleteEgressOnlyInternetGatewayRequest._(
            dryRun: BuiltValueNullFieldError.checkNotNull(
                dryRun, r'DeleteEgressOnlyInternetGatewayRequest', 'dryRun'),
            egressOnlyInternetGatewayId: BuiltValueNullFieldError.checkNotNull(
                egressOnlyInternetGatewayId,
                r'DeleteEgressOnlyInternetGatewayRequest',
                'egressOnlyInternetGatewayId'));
    replace(_$result);
