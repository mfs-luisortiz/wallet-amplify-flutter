...
class _$PacketHeaderStatementRequest extends PacketHeaderStatementRequest {
  @override
  final _i3.BuiltList<String>? sourceAddresses;
  @override
  final _i3.BuiltList<String>? destinationAddresses;
  @override
  final _i3.BuiltList<String>? sourcePorts;
  @override
  final _i3.BuiltList<String>? destinationPorts;
  @override
  final _i3.BuiltList<String>? sourcePrefixLists;
  @override
  final _i3.BuiltList<String>? destinationPrefixLists;
  @override
  final _i3.BuiltList<_i2.Protocol>? protocols;
...
class PacketHeaderStatementRequestBuilder
  ...
  _i3.ListBuilder<String>? _sourceAddresses;
  _i3.ListBuilder<String> get sourceAddresses =>
      _$this._sourceAddresses ??= new _i3.ListBuilder<String>();
  set sourceAddresses(_i3.ListBuilder<String>? sourceAddresses) =>
      _$this._sourceAddresses = sourceAddresses;

  _i3.ListBuilder<String>? _destinationAddresses;
  _i3.ListBuilder<String> get destinationAddresses =>
      _$this._destinationAddresses ??= new _i3.ListBuilder<String>();
  set destinationAddresses(_i3.ListBuilder<String>? destinationAddresses) =>
      _$this._destinationAddresses = destinationAddresses;

  _i3.ListBuilder<String>? _sourcePorts;
  _i3.ListBuilder<String> get sourcePorts =>
      _$this._sourcePorts ??= new _i3.ListBuilder<String>();
  set sourcePorts(_i3.ListBuilder<String>? sourcePorts) =>
      _$this._sourcePorts = sourcePorts;

  _i3.ListBuilder<String>? _destinationPorts;
  _i3.ListBuilder<String> get destinationPorts =>
      _$this._destinationPorts ??= new _i3.ListBuilder<String>();
  set destinationPorts(_i3.ListBuilder<String>? destinationPorts) =>
      _$this._destinationPorts = destinationPorts;

  _i3.ListBuilder<String>? _sourcePrefixLists;
  _i3.ListBuilder<String> get sourcePrefixLists =>
      _$this._sourcePrefixLists ??= new _i3.ListBuilder<String>();
  set sourcePrefixLists(_i3.ListBuilder<String>? sourcePrefixLists) =>
      _$this._sourcePrefixLists = sourcePrefixLists;

  _i3.ListBuilder<String>? _destinationPrefixLists;
  _i3.ListBuilder<String> get destinationPrefixLists =>
      _$this._destinationPrefixLists ??= new _i3.ListBuilder<String>();
  set destinationPrefixLists(_i3.ListBuilder<String>? destinationPrefixLists) =>
      _$this._destinationPrefixLists = destinationPrefixLists;

  _i3.ListBuilder<_i2.Protocol>? _protocols;
  _i3.ListBuilder<_i2.Protocol> get protocols =>
      _$this._protocols ??= new _i3.ListBuilder<_i2.Protocol>();
  set protocols(_i3.ListBuilder<_i2.Protocol>? protocols) =>
      _$this._protocols = protocols;

  PacketHeaderStatementRequestBuilder() {
    PacketHeaderStatementRequest._init(this);
  }
