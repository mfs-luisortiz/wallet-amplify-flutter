...
class _$RequestSpotFleetRequest extends RequestSpotFleetRequest {
  ...
  _$RequestSpotFleetRequest._(
      {required this.dryRun, required this.spotFleetRequestConfig})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'RequestSpotFleetRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(spotFleetRequestConfig,
        r'RequestSpotFleetRequest', 'spotFleetRequestConfig');
  }
      ...
      _$result = _$v ??
          new _$RequestSpotFleetRequest._(
              dryRun: BuiltValueNullFieldError.checkNotNull(
                  dryRun, r'RequestSpotFleetRequest', 'dryRun'),
              spotFleetRequestConfig: spotFleetRequestConfig.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'spotFleetRequestConfig';
        spotFleetRequestConfig.build();
      } catch (e) {
