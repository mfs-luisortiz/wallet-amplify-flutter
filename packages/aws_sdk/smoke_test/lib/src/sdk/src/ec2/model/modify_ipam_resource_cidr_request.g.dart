...
class _$ModifyIpamResourceCidrRequest extends ModifyIpamResourceCidrRequest {
  ...
  _$ModifyIpamResourceCidrRequest._(
      ...
      required this.resourceCidr,
      required this.resourceRegion,
      required this.currentIpamScopeId,
    ...
    BuiltValueNullFieldError.checkNotNull(
        resourceId, r'ModifyIpamResourceCidrRequest', 'resourceId');
    BuiltValueNullFieldError.checkNotNull(
        resourceCidr, r'ModifyIpamResourceCidrRequest', 'resourceCidr');
    BuiltValueNullFieldError.checkNotNull(
        resourceRegion, r'ModifyIpamResourceCidrRequest', 'resourceRegion');
    BuiltValueNullFieldError.checkNotNull(currentIpamScopeId,
        r'ModifyIpamResourceCidrRequest', 'currentIpamScopeId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$ModifyIpamResourceCidrRequest._(
            ...
            resourceId: BuiltValueNullFieldError.checkNotNull(
                resourceId, r'ModifyIpamResourceCidrRequest', 'resourceId'),
            resourceCidr: BuiltValueNullFieldError.checkNotNull(
                resourceCidr, r'ModifyIpamResourceCidrRequest', 'resourceCidr'),
            resourceRegion: BuiltValueNullFieldError.checkNotNull(
                resourceRegion,
                r'ModifyIpamResourceCidrRequest',
                'resourceRegion'),
            currentIpamScopeId: BuiltValueNullFieldError.checkNotNull(
                currentIpamScopeId,
                r'ModifyIpamResourceCidrRequest',
                'currentIpamScopeId'),
