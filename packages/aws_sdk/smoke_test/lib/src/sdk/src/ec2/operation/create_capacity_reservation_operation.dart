...
class CreateCapacityReservationOperation extends _i1.HttpOperation<
    _i2.CreateCapacityReservationRequest,
    _i2.CreateCapacityReservationRequest,
    _i3.CreateCapacityReservationResult,
    _i3.CreateCapacityReservationResult> {
  /// Creates a new Capacity Reservation with the specified attributes.
  ///
  /// Capacity Reservations enable you to reserve capacity for your Amazon EC2 instances in a specific Availability Zone for any duration. This gives you the flexibility to selectively add capacity reservations and still get the Regional RI discounts for that usage. By creating Capacity Reservations, you ensure that you always have access to Amazon EC2 capacity when you need it, for as long as you need it. For more information, see [Capacity Reservations](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-capacity-reservations.html) in the _Amazon EC2 User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateCapacityReservationRequest,
          _i3.CreateCapacityReservationResult,
          _i3.CreateCapacityReservationResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateCapacityReservationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateCapacityReservationResult? output]) => 200;
  @override
  _i3.CreateCapacityReservationResult buildOutput(
    _i3.CreateCapacityReservationResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateCapacityReservationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateCapacityReservationResult> run(
    _i2.CreateCapacityReservationRequest input, {
