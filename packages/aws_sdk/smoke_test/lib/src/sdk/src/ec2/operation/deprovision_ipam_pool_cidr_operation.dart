...
class DeprovisionIpamPoolCidrOperation extends _i1.HttpOperation<
    _i2.DeprovisionIpamPoolCidrRequest,
    _i2.DeprovisionIpamPoolCidrRequest,
    _i3.DeprovisionIpamPoolCidrResult,
    _i3.DeprovisionIpamPoolCidrResult> {
  /// Deprovision a CIDR provisioned from an IPAM pool. If you deprovision a CIDR from a pool that has a source pool, the CIDR is recycled back into the source pool. For more information, see [Deprovision pool CIDRs](https://docs.aws.amazon.com/vpc/latest/ipam/depro-pool-cidr-ipam.html) in the _Amazon VPC IPAM User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DeprovisionIpamPoolCidrRequest,
          _i3.DeprovisionIpamPoolCidrResult,
          _i3.DeprovisionIpamPoolCidrResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeprovisionIpamPoolCidrRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DeprovisionIpamPoolCidrResult? output]) => 200;
  @override
  _i3.DeprovisionIpamPoolCidrResult buildOutput(
    _i3.DeprovisionIpamPoolCidrResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DeprovisionIpamPoolCidrResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DeprovisionIpamPoolCidrResult> run(
    _i2.DeprovisionIpamPoolCidrRequest input, {
