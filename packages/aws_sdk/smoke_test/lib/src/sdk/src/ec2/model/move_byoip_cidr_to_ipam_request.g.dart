...
class _$MoveByoipCidrToIpamRequest extends MoveByoipCidrToIpamRequest {
  ...
  _$MoveByoipCidrToIpamRequest._(
      ...
      required this.ipamPoolOwner})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        dryRun, r'MoveByoipCidrToIpamRequest', 'dryRun');
    BuiltValueNullFieldError.checkNotNull(
        cidr, r'MoveByoipCidrToIpamRequest', 'cidr');
    BuiltValueNullFieldError.checkNotNull(
        ipamPoolId, r'MoveByoipCidrToIpamRequest', 'ipamPoolId');
    BuiltValueNullFieldError.checkNotNull(
        ipamPoolOwner, r'MoveByoipCidrToIpamRequest', 'ipamPoolOwner');
  }
    ...
    final _$result = _$v ??
        new _$MoveByoipCidrToIpamRequest._(
            ...
            ipamPoolId: BuiltValueNullFieldError.checkNotNull(
                ipamPoolId, r'MoveByoipCidrToIpamRequest', 'ipamPoolId'),
            ipamPoolOwner: BuiltValueNullFieldError.checkNotNull(
                ipamPoolOwner, r'MoveByoipCidrToIpamRequest', 'ipamPoolOwner'));
    replace(_$result);
    return _$result;
  }
