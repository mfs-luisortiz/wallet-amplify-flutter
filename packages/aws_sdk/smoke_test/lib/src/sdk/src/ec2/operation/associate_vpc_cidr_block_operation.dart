...
class AssociateVpcCidrBlockOperation extends _i1.HttpOperation<
    _i2.AssociateVpcCidrBlockRequest,
    _i2.AssociateVpcCidrBlockRequest,
    _i3.AssociateVpcCidrBlockResult,
    _i3.AssociateVpcCidrBlockResult> {
  /// Associates a CIDR block with your VPC. You can associate a secondary IPv4 CIDR block, an Amazon-provided IPv6 CIDR block, or an IPv6 CIDR block from an IPv6 address pool that you provisioned through bring your own IP addresses ([BYOIP](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-byoip.html)). The IPv6 CIDR block size is fixed at /56.
  ///
  /// You must specify one of the following in the request: an IPv4 CIDR block, an IPv6 pool, or an Amazon-provided IPv6 CIDR block.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.AssociateVpcCidrBlockRequest,
          _i3.AssociateVpcCidrBlockResult,
          _i3.AssociateVpcCidrBlockResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.AssociateVpcCidrBlockRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.AssociateVpcCidrBlockResult? output]) => 200;
  @override
  _i3.AssociateVpcCidrBlockResult buildOutput(
    _i3.AssociateVpcCidrBlockResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.AssociateVpcCidrBlockResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.AssociateVpcCidrBlockResult> run(
    _i2.AssociateVpcCidrBlockRequest input, {
