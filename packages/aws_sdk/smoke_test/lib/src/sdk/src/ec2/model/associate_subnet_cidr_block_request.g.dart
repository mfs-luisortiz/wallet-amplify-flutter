...
class _$AssociateSubnetCidrBlockRequest
  ...
  _$AssociateSubnetCidrBlockRequest._(
      {required this.ipv6CidrBlock, required this.subnetId})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        ipv6CidrBlock, r'AssociateSubnetCidrBlockRequest', 'ipv6CidrBlock');
    BuiltValueNullFieldError.checkNotNull(
        subnetId, r'AssociateSubnetCidrBlockRequest', 'subnetId');
  }
...
class AssociateSubnetCidrBlockRequestBuilder
  ...
  AssociateSubnetCidrBlockRequestBuilder() {
    AssociateSubnetCidrBlockRequest._init(this);
  }
  ...
  _$AssociateSubnetCidrBlockRequest _build() {
    final _$result = _$v ??
        new _$AssociateSubnetCidrBlockRequest._(
            ipv6CidrBlock: BuiltValueNullFieldError.checkNotNull(ipv6CidrBlock,
                r'AssociateSubnetCidrBlockRequest', 'ipv6CidrBlock'),
