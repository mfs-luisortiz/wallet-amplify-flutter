...
class _$CopyImageRequest extends CopyImageRequest {
  ...
  _$CopyImageRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(name, r'CopyImageRequest', 'name');
    BuiltValueNullFieldError.checkNotNull(
        sourceImageId, r'CopyImageRequest', 'sourceImageId');
    BuiltValueNullFieldError.checkNotNull(
        sourceRegion, r'CopyImageRequest', 'sourceRegion');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$CopyImageRequest._(
            ...
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'CopyImageRequest', 'name'),
            sourceImageId: BuiltValueNullFieldError.checkNotNull(
                sourceImageId, r'CopyImageRequest', 'sourceImageId'),
