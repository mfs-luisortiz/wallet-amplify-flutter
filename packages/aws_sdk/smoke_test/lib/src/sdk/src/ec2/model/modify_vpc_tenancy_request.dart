...
import 'package:smoke_test/src/sdk/src/ec2/model/vpc_tenancy.dart' as _i3;
...
abstract class ModifyVpcTenancyRequest
  ...
  factory ModifyVpcTenancyRequest({
    ...
    required _i3.VpcTenancy instanceTenancy,
    bool? dryRun,
  }) {
    dryRun ??= false;
  ...
  _i3.VpcTenancy get instanceTenancy;
...
class ModifyVpcTenancyRequestEc2QuerySerializer
      ...
      switch (key) {
        ...
        case 'InstanceTenancy':
          result.instanceTenancy = (serializers.deserialize(
            value,
            specifiedType: const FullType(_i3.VpcTenancy),
          ) as _i3.VpcTenancy);
        case 'DryRun':
  ...
  Iterable<Object?> serialize(
    ...
    result$
      ...
      ..add(serializers.serialize(
        instanceTenancy,
        specifiedType: const FullType.nullable(_i3.VpcTenancy),
      ));
    result$
