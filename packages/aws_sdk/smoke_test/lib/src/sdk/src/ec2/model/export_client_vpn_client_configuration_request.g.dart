...
class _$ExportClientVpnClientConfigurationRequest
  ...
  _$ExportClientVpnClientConfigurationRequest._(
      {required this.clientVpnEndpointId, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(clientVpnEndpointId,
        r'ExportClientVpnClientConfigurationRequest', 'clientVpnEndpointId');
    ...
    final _$result = _$v ??
        new _$ExportClientVpnClientConfigurationRequest._(
            clientVpnEndpointId: BuiltValueNullFieldError.checkNotNull(
                clientVpnEndpointId,
                r'ExportClientVpnClientConfigurationRequest',
                'clientVpnEndpointId'),
