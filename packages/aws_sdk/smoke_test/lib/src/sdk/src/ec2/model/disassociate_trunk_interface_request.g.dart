...
class _$DisassociateTrunkInterfaceRequest
  ...
  _$DisassociateTrunkInterfaceRequest._(
      {required this.associationId, this.clientToken, required this.dryRun})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        associationId, r'DisassociateTrunkInterfaceRequest', 'associationId');
    BuiltValueNullFieldError.checkNotNull(
    ...
    final _$result = _$v ??
        new _$DisassociateTrunkInterfaceRequest._(
            associationId: BuiltValueNullFieldError.checkNotNull(associationId,
                r'DisassociateTrunkInterfaceRequest', 'associationId'),
